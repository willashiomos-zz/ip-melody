  ...
  return (function (t) {
    ...
    function (t, e, s) {
      ...
      const a = new WeakSet(),
        ...
        k = () => new DOMException("", "IndexSizeError"),
        C = (t) => {
          var e;
          t.getChannelData =
            ((e = t.getChannelData),
            (s) => {
              try {
                ...
                if (12 === t.code) throw k();
                throw t;
              }
            });
        },
        A = { numberOfChannels: 1 },
        D = -34028234663852886e22,
        O = -D,
        M = (t) => a.has(t),
        E = (t, e) => {
          const s = t.get(e);
        ...
        P = (t) => E(u, t),
        j = (t, e) => {
          const { activeInputs: s } = N(t);
          s.forEach((s) =>
            s.forEach(([s]) => {
              e.includes(t) || j(s, [...e, t]);
            })
          );
          ...
          for (const t of n) {
            const s = P(t);
            void 0 !== s && s.activeInputs.forEach(([t]) => j(t, e));
          }
          M(t) && F(t);
        },
        L = (t) => {
        ...
        Z = (t, e, s, n) => {
          U(e) ? t.disconnect(e.inputs[n], s, 0) : t.disconnect(e, s, n);
        },
        X = (t) => E(h, t),
        Y = (t) => E(l, t),
        H = (t, e, s, n) => {
        ...
        nt = (t) => "context" in t,
        it = (t, e, [s, n, i], o) => {
          H(t[n], [e, s, i], (t) => t[0] === e && t[1] === s, o);
        },
        ot = (t, e, [s, n], i) => {
          H(t, [e, s, n], (t) => t[0] === e && t[1] === s, i);
        },
        rt = (t, e, [s, n, i], o) => {
          const r = t.get(s);
          void 0 === r
            ? t.set(s, new Set([[n, e, i]]))
            : H(r, [n, e, i], (t) => t[0] === n && t[1] === e, o);
        },
        at = (t, [e, s, n], i) => {
          const o = t.get(e);
          void 0 === o
        ...
        ut = (t, e, s, n, i) => {
          const { activeInputs: o, passiveInputs: r } = N(e),
            { outputs: a } = N(t),
            c = R(t),
            h = (a) => {
              const c = X(e),
              ...
              if (a) {
                const a = ct(r, t, s, n);
                it(o, t, a, !1), i || $(t) || G(h, c, s, n), J(e) && q(e);
              } else {
                const a = ((t, e, s, n) =>
                  K(t[n], (t) => t[0] === e && t[1] === s))(o, t, s, n);
                rt(r, n, a, !1), i || $(t) || Z(h, c, s, n), M(e) && tt(e, o);
              }
            };
          return (
            !!H(
            ...
            (c.add(h),
            M(t) ? it(o, t, [s, n, h], !0) : rt(r, n, [t, s, h], !0),
            !0)
          );
        },
        lt = (t, e, s, n) => {
          const { activeInputs: i, passiveInputs: o } = P(e),
            { outputs: r } = N(t),
            a = R(t),
            c = (r) => {
              const a = X(t),
              ...
              if (r) {
                const e = ht(o, t, s);
                ot(i, t, e, !1), n || $(t) || a.connect(c, s);
              } else {
                const e = ((t, e, s) => K(t, (t) => t[0] === e && t[1] === s))(
                  i,
                  t,
                  s
                );
                at(o, e, !1), n || $(t) || a.disconnect(c, s);
              }
            };
          return (
            !!H(r, [e, s], (t) => t[0] === e && t[1] === s, !0) &&
            (a.add(c), M(t) ? ot(i, t, [s, c], !0) : at(o, [t, s, c], !0), !0)
          );
        },
        pt = (t, e, s) => {
          for (const n of t)
        ...
        dt = (t, e, s, n, i) => {
          const [o, r] = ((t, e, s, n) => {
            const { activeInputs: i, passiveInputs: o } = N(e),
              r = pt(i[n], t, s);
            if (null === r) {
              return [ct(o, t, s, n)[2], !1];
            }
            return [r[2], !0];
          })(t, s, n, i);
          if (
            (null !== o && (Q(t, o), !r || e || $(t) || Z(X(t), X(s), n, i)),
            M(s))
          ) {
            const { activeInputs: t } = N(s);
            tt(s, t);
          }
        },
        ft = (t, e, s, n) => {
          const [i, o] = ((t, e, s) => {
            const { activeInputs: n, passiveInputs: i } = P(e),
              o = pt(n, t, s);
            if (null === o) {
              return [ht(i, t, s)[1], !1];
            }
          ...
          null !== i && (Q(t, i), !o || e || $(t) || X(t).disconnect(Y(s), n));
        };
      class _t {
        constructor(t) {
          this._map = new Map(t);
      ...
      const vt = (t, e, s, n, i) => {
        ...
        xt = async (t, e, s, n, i, o, r) => {
          ...
          const l = N(t),
            ...
            d = yt(n.numberOfInputs, n.channelCount),
            f = yt(n.numberOfOutputs, i),
            ...
            try {
              ...
              if (null !== u)
                for (let t = 0, e = 0; t < n.numberOfOutputs; t += 1) {
                  for (let s = 0; s < i[t]; s += 1) vt(u, f[t], s, e + s, h);
                  e += i[t];
                }
              if (!e) break;
            } catch (e) {
        ...
        Mt = () => new DOMException("", "InvalidStateError"),
        Et = () => new DOMException("", "InvalidAccessError"),
        Rt = {
          channelCount: 2,
          channelCountMode: "max",
          channelInterpretation: "speakers",
        },
        qt = (t, e, s, n, i, o, r, a, c, h, u) => {
          const l = h.length;
          let p = a;
          for (let a = 0; a < l; a += 1) {
            let l = s[0] * h[a];
        ...
        Pt = (t, e) => {
          Nt(t, e, "channelCount"),
            Nt(t, e, "channelCountMode"),
            Nt(t, e, "channelInterpretation");
        },
        jt = (t) => "function" == typeof t.getFloatTimeDomainData,
        Lt = (t, e, s) => {
          const n = e[s];
        ...
        Xt = (t, e) => {
          ...
          return Pt(s, e), Lt(s, e, "delayTime"), s;
        },
        Yt = (t, e) => {
          const s = t.createGain();
          return Pt(s, e), Lt(s, e, "gain"), s;
        };
      function Ht(t, e) {
      ...
      const Jt = (t, e, s, n) => t.createScriptProcessor(e, s, n),
        Kt = () => new DOMException("", "NotSupportedError"),
        te = { numberOfChannels: 1 },
        ee = {
          channelCount: 2,
          channelCountMode: "max",
          channelInterpretation: "speakers",
            ...
            try {
              ...
              return s instanceof Promise
                ? (ge.set(t, s),
                  s
                    .catch(() => !1)
                    .then((e) => (ge.delete(t), ve.set(t, e), e)))
                : (ve.set(t, s), s);
            } catch {
              return ve.set(t, !1), !1;
            }
      ...
      var ge, ve;
      const ye = "undefined" == typeof window ? null : window,
        xe =
          ((we = me),
          (be = k),
          (t, e) => {
            const s = t.createAnalyser();
            if ((Pt(s, e), !(e.maxDecibels > e.minDecibels))) throw be();
            return (
              Nt(s, e, "fftSize"),
              Nt(s, e, "maxDecibels"),
              Nt(s, e, "minDecibels"),
              Nt(s, e, "smoothingTimeConstant"),
              we(jt, () => jt(s)) ||
                ((t) => {
              ...
              render(e, s, n) {
                ...
                return void 0 !== i
                  ...
                  : (async (e, s, n) => {
                      ...
                      return t.set(s, i), await Oe(e, s, i, n), i;
                    })(e, s, n);
              },
            };
          });
      ...
      const Re = ((t) =>
          null === t
            ...
            : null)(ye),
        qe = ((Fe = Re), (t) => null !== Fe && t instanceof Fe);
      var Fe;
      ...
      const Pe = ((t) =>
          null === t
            ...
            : null)(ye),
        je = ((Le = Pe), (t) => null !== Le && t instanceof Le);
      var Le;
      const ze = ((t) => (e) =>
          null !== t &&
          "function" == typeof t.AudioNode &&
          e instanceof t.AudioNode)(ye),
        Be = ((t) => (e) =>
          null !== t &&
          "function" == typeof t.AudioParam &&
          e instanceof t.AudioParam)(ye),
        We = ((t, e, s, n, i, o, r, a, c, u, l, p, f, _) =>
          class extends c {
            constructor(s, n, i, o) {
              super(i), (this._context = s), (this._nativeAudioNode = i);
              const r = u(s);
              l(r) &&
                !0 !== e(et, () => et(r)) &&
                ((t) => {
            ...
            connect(t, e = 0, r = 0) {
              ...
              if (B(t)) {
                const n = X(t);
                try {
                  const s = G(this._nativeAudioNode, n, e, r),
                    i = J(this);
                  (h || i) && this._nativeAudioNode.disconnect(...s),
                    "closed" !== this.context.state && !i && J(t) && q(t);
                } catch (t) {
              ...
              const l = Y(t);
              if ("playbackRate" === l.name) throw o();
              try {
                this._nativeAudioNode.connect(l, e),
                  (h || J(this)) && this._nativeAudioNode.disconnect(l, e);
              } catch (t) {
                if (12 === t.code) throw i();
                throw t;
              }
              ...
              if (void 0 === t)
                o = ((t, e) => {
                  ...
                  for (const i of s.outputs)
                    W(i) ? dt(t, e, ...i) : ft(t, e, ...i), n.push(i[0]);
                  return s.outputs.clear(), n;
                })(this, h);
              else if ("number" == typeof t) {
                if (t < 0 || t >= this.numberOfOutputs) throw n();
                o = ((t, e, s) => {
                  const n = N(t),
                    i = [];
                  for (const o of n.outputs)
                    o[1] === s &&
                      (W(o) ? dt(t, e, ...o) : ft(t, e, ...o),
                      i.push(o[0]),
                      n.outputs.delete(o));
                  return i;
                })(this, h, t);
      ...
      const Ge = ((t, e, s, n, i, o) =>
        ...
        Ze = ((t) =>
          null === t
            ...
            ? t.AudioBuffer
            : null)(ye),
        Xe = ((Ye = new Uint32Array(1)), (t) => ((Ye[0] = t), Ye[0]));
      var Ye;
      const He = ((t, e) => (s) => {
        ...
        Je = ((t, e, s, n, i, o, r, a) => {
          ...
          () => {
            if (null === Ke) return !1;
            try {
              new Ke({ length: 1, sampleRate: 44100 });
            } catch {
              return !1;
            }
            return !0;
      ...
      const ss = ((t, e, s) => async (n, i, o, r) => {
        ...
        ns = ((t) => (e, s, n, i) => t(s, e, n, i))(ss),
        is = ((t, e, s, n, i, o, r, a, c, h, u) => (l, p) => {
          ...
          ((os = ce),
          (t, e) => {
            const s = e.createBuffer(1, 1, e.sampleRate);
      ...
      var os;
      const rs = ((t, e) => (s, n, i, o) => (t(n).replay(i), e(n, s, i, o)))(
          ((t) => (e) => {
            const s = t(e);
            if (null === s.renderer)
              throw new Error(
            ...
            x = {
              ...
              setValueCurveAtTime(t, e, s) {
                ...
                if (null !== p && "webkitAudioContext" === p.name) {
                  ...
                  null === y && v.flush(d.context.currentTime),
                    v.add(l(c, e, s)),
                    _.setValueCurveAtTime(c, e, s);
                  const h = r / i;
                  h < t && x.setValueAtTime(c[c.length - 1], h),
                    x.setValueAtTime(n[n.length - 1], t);
                } else
                  null === y && v.flush(d.context.currentTime),
                    v.add(l(n, e, s)),
                    _.setValueCurveAtTime(n, e, s);
                return x;
              },
            };
          ...
          class extends t {
            constructor(t, n) {
              ...
              super(t, !1, h, l),
                ...
                (this._onended = null),
                (this._playbackRate = s(this, u, h.playbackRate, O, D));
            }
            get buffer() {
          ...
          class extends fs {
            constructor(t, e) {
              const s = ys(t),
                ...
                i = vs(s, n),
                o = xs(s);
              super(t, !1, i, o ? ms() : null),
                (this._Q = _s(this, o, i.Q, O, D)),
                (this._detune = _s(
                  this,
                  o,
                  i.detune,
                ...
                (this._gain = _s(this, o, i.gain, 40 * Math.log10(O), D)),
            ...
            getFrequencyResponse(t, e, s) {
              if (
                ...
                t.length !== e.length || e.length !== s.length)
              )
                throw gs();
            }
          });
      var fs, _s, ms, gs, vs, ys, xs;
      const ws = ((t, e) => (s, n, i) => {
          const o = new Set();
          var r, a;
          return (
      ...
      const ks = ((t, e) => (s, n) => {
        ...
        Ds = ((t, e, s, n) => (i, { offset: o, ...r }) => {
          const a = i.createBuffer(1, 2, i.sampleRate),
            c = e(i, {
              buffer: null,
              channelCount: 2,
              channelCountMode: "max",
          ...
          class extends t {
            constructor(t, r) {
              ...
              super(t, !1, h, l),
                ...
                (this._offset = e(this, u, h.offset, O, D)),
                (this._onended = null);
            }
            get offset() {
              return this._offset;
          ...
          class extends t {
            constructor(t, r) {
              const a = i(t),
                ...
                h = n(a, c),
                u = o(a);
              super(t, !1, h, u ? s(c.maxDelayTime) : null),
                (this._delayTime = e(this, u, h.delayTime));
            }
            get delayTime() {
        ...
        Fs =
          ...
          (t, e) => {
            ...
            if ((Pt(s, e), e.channelCount > 2)) throw Is();
            if ("max" === e.channelCountMode) throw Is();
            return (
              Lt(s, e, "attack"),
              Lt(s, e, "knee"),
              Lt(s, e, "ratio"),
          ...
          class extends t {
            constructor(t, i) {
              ...
              super(t, !1, h, u ? s() : null),
                (this._attack = e(this, u, h.attack)),
                (this._knee = e(this, u, h.knee)),
                (this._nativeDynamicsCompressorNode = h),
                (this._ratio = e(this, u, h.ratio)),
                (this._release = e(this, u, h.release)),
                (this._threshold = e(this, u, h.threshold));
            }
            get attack() {
              return this._attack;
            }
          ...
          class extends t {
            constructor(t, r) {
              const a = i(t),
                ...
                u = o(a);
              super(t, !1, h, u ? s() : null),
                (this._gain = e(this, u, h.gain, O, D));
            }
            get gain() {
              return this._gain;
            }
        ...
        Ps = ((t, e, s, n) => (
          ...
          g.onaudioprocess = (t) => {
            ...
            for (let t = 0; t < n; t += 1) {
              ...
              v[t] = qt(p, f, d, _, m, y[t], x[t], v[t], 32, n, i);
            }
          };
          ...
          class extends t {
            constructor(t, o) {
              const r = n(t),
                a = i(r),
                c = { ...Rt, ...o },
                h = e(r, a ? null : t.baseLatency, c);
              super(t, !1, h, a ? s(c.feedback, c.feedforward) : null),
                ((t) => {
                  var e;
        ...
        Xs =
          ...
          (t, e) => {
            const s = Ys(t, {
              ...
              n = t.createBuffer(1, 2, t.sampleRate);
            return (
              (s.buffer = n),
              (s.loop = !0),
              s.connect(e),
      ...
      var Ys;
      const Hs = ((t, e, s, n, i) => (o, { curve: r, oversample: a, ...c }) => {
        ...
        $s = ((t, e, s, n, i, o, r) => (a, c) => {
          ...
          Nt(h, { curve: u }, "curve"), Nt(h, c, "oversample");
          let l = null,
            p = !1;
          r(
            h,
          ...
          (t, e) => {
            ...
            return void 0 === s.orientationX
              ...
              : (Pt(s, e),
                ...
                Lt(s, e, "positionY"),
                Lt(s, e, "positionZ"),
                Nt(s, e, "coneInnerAngle"),
                Nt(s, e, "coneOuterAngle"),
                Nt(s, e, "coneOuterGain"),
                Nt(s, e, "distanceModel"),
                Nt(s, e, "maxDistance"),
                Nt(s, e, "panningModel"),
                Nt(s, e, "refDistance"),
                Nt(s, e, "rolloffFactor"),
                s);
          });
      var tn;
      const en = ((t, e, s, n, i, o) =>
          class extends t {
            constructor(t, r) {
              const a = i(t),
                c = { ...se, ...r },
              ...
              super(t, !1, h, u ? n() : null),
                (this._nativePannerNode = h),
                (this._orientationX = e(this, u, h.orientationX, O, D)),
        ...
        cn = ((t) => null !== t && t.isSecureContext)(ye),
        hn = ((t) => (e, s, n) => {
        ...
        dn = cn
          ? ((t, e, s, n, i, o, r, a, c, h, u, l) => (
              ...
              const T = i(d)
                .then((t) => {
                  const [e, n] = y(t, g);
                  return s(
                    `${e};((a,b)=>{(a[b]=a[b]||[]).push((AudioWorkletProcessor,global,registerProcessor,sampleRate,self,window)=>{${n}\n})})(window,'_AWGS')`
                  );
                })
                .then(() => {
                  const t = l._AWGS.pop();
          ...
          : void 0,
        fn = ((t, e) => (s) => t(s) || e(s))(je, qe),
        _n = ((t, e, s, n, i, o, r, a, c, h, u, l, p, d, f, _, m, g, v, y) =>
          class extends f {
            constructor(e, s) {
              super(e, s),
              ...
              : new Promise((e, s) => {
                  ...
                  try {
                    d.decodeAudioData(
                      p,
                      (s) => {
                        "function" != typeof s.copyFromChannel && (h(s), C(s)),
                          t.add(s),
                          i(),
                          e(s);
                      },
        ...
        mn = ((t, e, s, n) =>
          ...
          })(We, (t, e) => t.createMediaElementSource(e.mediaElement), Me, qe),
        gn = ((t, e, s, n) =>
          class extends t {
            constructor(t, i) {
              const o = s(t);
      ...
      var Sn;
      const kn = ((t) => (e, s, n = 0, i = 0) => {
          const o = e[n];
          if (void 0 === o) throw t();
          return nt(s) ? o.connect(s, 0, i) : o.connect(s, 0);
        })(k),
        Cn = ((t) => (e, s) => {
          t(e).delete(s);
        })(wn),
        An = ((t) => (e, s, n, i = 0) =>
          void 0 === s
            ...
            ? void 0 === n
              ...
              : void 0 === i
              ? At(t, e, n).disconnect(s, 0)
              : At(t, e, n).disconnect(s, 0, i)
            : void 0 === n
            ? e.forEach((t) => t.disconnect(s))
            : At(t, e, n).disconnect(s, 0))(k),
        Dn = new WeakMap(),
        On = ((t, e) => (s) => e(t, s))(Dn, E),
        Mn = ((t, e, s, n, i, o, r, a, c, h, u, l, p) => (d, f, _, g) => {
          ...
          if (void 0 !== _.parameterDescriptors)
            for (const {
              ...
              Object.defineProperties(i.offset, {
                ...
                maxValue: { get: () => (void 0 === e ? O : e) },
                minValue: { get: () => (void 0 === s ? D : s) },
              }),
                k.push(i);
            }
          const C = n(d, {
          ...
          C.connect(M);
          let F = g.channelInterpretation,
            I = null;
          const V = 0 === g.numberOfOutputs ? [M] : R,
            N = {
              get bufferSize() {
                return A;
              },
              ...
              set onprocessorerror(t) {
                "function" == typeof I &&
                  N.removeEventListener("processorerror", I),
                  (I = "function" == typeof t ? t : null),
                  "function" == typeof I &&
                    N.addEventListener("processorerror", I);
              },
              get parameters() {
                return q;
              },
          ...
          const W = yt(g.numberOfInputs, g.channelCount),
            U = yt(g.numberOfOutputs, v),
            G =
              void 0 === _.parameterDescriptors
                ? []
          ...
          let Q = !0;
          const Z = () => {
            g.numberOfOutputs > 0 && M.disconnect(E);
            for (let t = 0, e = 0; t < g.numberOfOutputs; t += 1) {
              const s = R[t];
              for (let n = 0; n < v[t]; n += 1) E.disconnect(s, e + n, n);
              e += v[t];
            }
          };
          M.onaudioprocess = ({ inputBuffer: t, outputBuffer: e }) => {
            if (null !== B)
              for (let s = 0; s < A; s += 128) {
                for (let e = 0; e < g.numberOfInputs; e += 1)
                  for (let n = 0; n < g.channelCount; n += 1)
                    gt(t, W[e], n, n, s);
                void 0 !== _.parameterDescriptors &&
                  _.parameterDescriptors.forEach(({ name: e }, n) => {
                    gt(t, G, e, y + n, s);
                  });
                for (let t = 0; t < g.numberOfInputs; t += 1)
                  for (let e = 0; e < v[t]; e += 1)
                    0 === U[t][e].byteLength &&
                      (U[t][e] = new Float32Array(128));
                try {
                  const t = l(N),
                    n = W.map((e, s) => (t[s].size > 0 ? e : [])),
                    i = u(d.currentTime + s / d.sampleRate, d.sampleRate, () =>
                      B.process(n, U, G)
                    );
                  Q = i;
                  for (let t = 0, n = 0; t < g.numberOfOutputs; t += 1) {
                    for (let i = 0; i < v[t]; i += 1) vt(e, U[t], i, n + i, s);
                    n += v[t];
                  }
                } catch (t) {
                  (Q = !1),
                ...
                if (!Q) {
                  for (let t = 0; t < g.numberOfInputs; t += 1) {
                    T[t].disconnect(S[t]);
                    for (let e = 0; e < g.channelCount; e += 1)
                      S[s].disconnect(C, e, t * g.channelCount + e);
                  }
                  if (void 0 !== _.parameterDescriptors) {
                  ...
                  C.disconnect(M), (M.onaudioprocess = null), X ? Z() : $();
                  break;
                }
              }
          };
          ...
          const Y = r(d, {
            ...
            H = () => M.connect(Y).connect(d.destination),
            $ = () => {
              M.disconnect(Y), Y.disconnect();
            };
          return (
            H(),
            p(
              ...
              () => {
                if (Q) {
                  $(), g.numberOfOutputs > 0 && M.connect(E);
                  for (let t = 0, e = 0; t < g.numberOfOutputs; t += 1) {
                    const s = R[t];
                    for (let n = 0; n < v[t]; n += 1) E.connect(s, e + n, n);
                    e += v[t];
                  }
                }
                X = !0;
        ...
        })(kn, k, Mt, ks, Qt, Os, Yt, Jt, Kt, An, hn, On, ws),
        En = ((t, e, s, n, i) => (o, r, a, c, h, u) => {
          if (null !== a)
            try {
              const e = new a(o, c, u),
                n = new Map();
        ...
        Rn = ((t, e, s, n, i, o, r, a, c, h, u, l, p, d, f, _) => (m, g, v) => {
          const y = new WeakMap();
          let x = null;
          return {
            render(w, b, S) {
              ...
              return void 0 !== k
                ...
                : (async (a, w, b) => {
                    let S = u(a),
                      k = null;
                    const C = T(S, w),
                      A = Array.isArray(g.outputChannelCount)
                        ? g.outputChannelCount
                        : Array.from(g.outputChannelCount);
                    if (null === l) {
                    ...
                    if ((y.set(w, null === k ? S : k[2]), null !== k)) {
                      if (null === x) {
                        if (void 0 === v)
                          throw new Error("Missing the processor constructor.");
                        if (null === p)
                        ...
                        x = xt(a, 0 === s ? null : await c(), w, g, A, v, h);
                      }
                      const t = await x,
                        e = s(w, {
                          buffer: null,
                    ...
                    if (C)
                      for (const [e, s] of a.parameters.entries())
                        await t(w, s, S.parameters.get(e), b);
                    else
                      for (const [t, e] of a.parameters.entries())
                        await d(w, e, S.parameters.get(t), b);
                    return await f(a, w, S, b), S;
                  })(w, b, S);
            },
          };
        })(ns, kn, is, ks, Qt, Os, Yt, Cn, An, hn, X, pn, Re, rs, ke, js),
        qn = ((t) => (e) => t.get(e))(un),
        Fn = ((t) => (e, s) => {
          t.set(e, s);
        })(Dn),
        ...
        })(Qe, me, Te, wn, js, S, He, $e),
        Pn =
          (((t, e, s, n, i) => {})(me, Mt, Vn, Gs, Nn),
          ((t, e, s, n, i) =>
            class extends t {
              constructor(t, s, i) {
                let o;
        ...
        Ln = ((zn = h), (Bn = ze), (t) => zn.has(t) || Bn(t));
      var zn, Bn;
      const Wn = ((Un = l), (Gn = Be), (t) => Un.has(t) || Gn(t));
      var Un, Gn;
      const Qn = ((t, e) => (s) => {
          const n = t.get(s);
          return e(n) || e(s);
        ...
        Zn = () =>
          (async (t, e, s, n, i, o, r, a, c, h, u, l, p, d, f, _) => {
            ...
            pe,
            ((t) => () => null !== t && t.hasOwnProperty("isSecureContext"))(
              ye
            ),
            ((t) => () => {
              if (null === t) return !1;
      ...
      function hi(t) {
        return ci(t) && /^([a-g]{1}(?:b|#|x|bb)?)(-?[0-9]+)/i.test(t);
      }
      const ui = "object" == typeof self ? self : null,
        li =
          ui &&
          (ui.hasOwnProperty("AudioContext") ||
            ui.hasOwnProperty("webkitAudioContext"));
      function pi(t, e, s, n) {
        var i,
          o = arguments.length,
          r =
        ...
        if (oi(t) && oi(s))
          for (const e in s)
            xi(e, s[e])
              ? (t[e] = s[e])
              : oi(s[e])
              ? (t[e] || Object.assign(t, { [e]: {} }), wi(t[e], s[e]))
      ...
      function bi(t, e, s = [], n) {
        const i = {},
          o = Array.from(e);
        if (oi(o[0]) && n && !Reflect.has(o[0], n)) {
          Object.keys(o[0]).some((e) => Reflect.has(t, e)) ||
            (wi(i, { [n]: o[0] }), s.splice(s.indexOf(n), 1), o.shift());
        }
        if (1 === o.length && oi(o[0])) wi(i, o[0]);
        else for (let t = 0; t < s.length; t++) si(o[t]) && (i[s[t]] = o[t]);
        return wi(t, i);
      }
      function Ti(t, e) {
        return ei(t) ? e : t;
       ...
       */ class ki {
        ...
        log(...t) {
          (this.debug || (ui && this.toString() === ui.TONE_DEBUG_CLASS)) &&
            Kn(this, ...t);
        }
        dispose() {
      ...
      class Ei extends ki {
        constructor() {
          ...
          const t = bi(Ei.getDefaults(), arguments, ["memory"]);
        ...
        cancel(t) {
          if (this._timeline.length > 1) {
            ...
            if (e >= 0)
              if (Oi(this._timeline[e].time, t)) {
                for (let s = e; s >= 0 && Oi(this._timeline[s].time, t); s--)
                  e = s;
          ...
          for (; s < i; ) {
            ...
            if (Oi(o[e], t)) {
              for (let s = n; s < this._timeline.length; s++) {
                if (!Oi(this._timeline[s][e], t)) break;
                n = s;
              }
              return n;
            }
            if (Di(o[e], t) && Ci(r[e], t)) return n;
            Ci(o[e], t) ? (i = n) : (s = n + 1);
          }
          return -1;
        }
        ...
        forEachAtTime(t, e) {
          const s = this._search(t);
          if (-1 !== s && Oi(this._timeline[s].time, t)) {
            let n = s;
            for (let e = s; e >= 0 && Oi(this._timeline[e].time, t); e--) n = e;
            this._iterate(
              (t) => {
                e(t);
              },
      ...
      class Vi extends ki {
        ...
        static mixin(t) {
          ["on", "once", "off", "emit"].forEach((e) => {
            const s = Object.getOwnPropertyDescriptor(Vi.prototype, e);
      ...
      class Pi extends Ni {
        constructor() {
          super(),
            ...
            (this._timeouts = new Ei()),
            (this._timeoutIds = 0),
            (this._initialized = !1),
            (this.isOffline = !1),
            (this._workletModules = new Map());
          const t = bi(Pi.getDefaults(), arguments, ["context"]);
          t.context
        ...
        initialize() {
          ...
          return (
            this._initialized ||
              ((t = this), Ri.forEach((e) => e(t)), (this._initialized = !0)),
            this
          );
        }
        createAnalyser() {
        ...
        createMediaStreamSource(t) {
          Xn(vi(this._context), "Not available if OfflineAudioContext");
        ...
        set draw(t) {
          Xn(!this._initialized, "Draw cannot be set after initialization."),
            (this._draw = t);
        }
        get destination() {
...
***************************************************************************** */ this
        ...
        addAudioWorkletModule(t, e) {
          return di(this, void 0, void 0, function* () {
            Xn(
              si(this.rawContext.audioWorklet),
        ...
        resume() {
          return "suspended" === this._context.state && vi(this._context)
        ...
        close() {
          return di(this, void 0, void 0, function* () {
            var t;
            vi(this._context) && (yield this._context.close()),
              this._initialized && ((t = this), Fi.forEach((e) => e(t)));
          });
        }
        getConstant(t) {
      ...
      class Bi extends ki {
        constructor() {
          ...
          const t = bi(Bi.getDefaults(), arguments, [
            "url",
            "onload",
            "onerror",
          ]);
          (this.reverse = t.reverse),
            ...
            (t.url && yi(t.url)) || t.url instanceof Bi
              ? this.set(t.url)
              : ci(t.url) && this.load(t.url).catch(t.onerror);
        }
        static getDefaults() {
          return { onerror: zi, onload: zi, reverse: !1 };
        }
        get sampleRate() {
          return this._buffer ? this._buffer.sampleRate : Qi().sampleRate;
        }
        set(t) {
          return (
            t instanceof Bi
        ...
        load(t) {
          return di(this, void 0, void 0, function* () {
            ...
            try {
              ...
              const t = Bi.downloads.indexOf(e);
              Bi.downloads.splice(t, 1);
            }
            return this;
          });
        }
        ...
        toMono(t) {
          if (ii(t)) this.fromArray(this.toArray(t));
          else {
        ...
        toArray(t) {
          if (ii(t)) return this.getChannelData(t);
        ...
        slice(t, e = this.duration) {
          ...
          Xn(s < n, "The start time must be less than the end time");
          const i = n - s,
            o = Qi().createBuffer(this.numberOfChannels, i, this.sampleRate);
        ...
        static loaded() {
          return di(this, void 0, void 0, function* () {
            for (yield Promise.resolve(); Bi.downloads.length; )
              yield Bi.downloads[0];
          });
        }
      }
      (Bi.baseUrl = ""), (Bi.downloads = []);
      class Wi extends Pi {
        constructor() {
          var t, e, s;
          super({
            clockSource: "offline",
            context: gi(arguments[0])
              ? arguments[0]
              : ((t = arguments[0]),
      ...
      let Gi = Ui;
      function Qi() {
        return Gi === Ui && li && Zi(new Pi()), Gi;
      }
      function Zi(t) {
        Gi = vi(t) ? new Pi(t) : gi(t) ? new Wi(t) : t;
      }
      function Xi() {
        return Gi.resume();
      }
      if (ui && !ui.TONE_SILENCE_LOGGING) {
        let t = "v";
        "dev" === o && (t = "");
        const e = ` * Tone.js ${t}${o} * `;
      ...
      let Ji = 440;
      function Ki(t) {
        return Math.round(to(t));
      }
      function to(t) {
        return 69 + 12 * Math.log2(t / Ji);
      }
      function eo(t) {
        return Ji * Math.pow(2, (t - 69) / 12);
      }
      class so extends ki {
        constructor(t, e, s) {
          super(),
        ...
        valueOf() {
          if (
            (this._val instanceof so && this.fromType(this._val), ei(this._val))
          )
            return this._noArg();
          if (ci(this._val) && ei(this._units)) {
            for (const t in this._expressions)
              if (this._expressions[t].regexp.test(this._val.trim())) {
                this._units = t;
                break;
              }
          } else if (oi(this._val)) {
            let t = 0;
          ...
          return ci(this._val) ? parseFloat(this._val) : this._val;
        }
        _frequencyToUnits(t) {
          return 1 / t;
        }
      ...
      class no extends so {
        ...
        _getExpressions() {
          return Object.assign(super._getExpressions(), {
            ...
            quantize: {
              method: (t) => {
                const e = new no(this.context, t).valueOf();
        ...
        toNotation() {
          ...
          e.push("0");
          let s = e[0],
            n = new no(this.context, e[0]).toSeconds();
          return (
            e.forEach((e) => {
              const i = new no(this.context, e).toSeconds();
      ...
      class oo extends no {
        ...
        _getExpressions() {
          return Object.assign({}, super._getExpressions(), {
            midi: {
              regexp: /^(\d+(?:\.\d+)?midi)/,
              method(t) {
                return "midi" === this.defaultUnits ? t : oo.mtof(t);
              },
            },
            note: {
              regexp: /^([a-g]{1}(?:b|#|x|bb)?)(-?[0-9]+)/i,
              method(t, e) {
                const s = ro[t.toLowerCase()] + 12 * (parseInt(e, 10) + 1);
                return "midi" === this.defaultUnits ? s : oo.mtof(s);
              },
            },
            tr: {
              regexp: /^(\d+(?:\.\d+)?):(\d+(?:\.\d+)?):?(\d+(?:\.\d+)?)?/,
        ...
        transpose(t) {
          return new oo(this.context, this.valueOf() * $i(t));
        }
        harmonize(t) {
          return t.map((t) => this.transpose(t));
        }
        toMidi() {
          return Ki(this.valueOf());
        }
        toNote() {
      ...
      const ro = {
        ...
        ao = ["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"];
      function co(t, e) {
        return new oo(Qi(), t, e);
      }
      class ho extends no {
        constructor() {
      ...
      function uo(t, e) {
        return new ho(Qi(), t, e);
      }
      class lo extends ki {
        constructor() {
          super();
          const t = bi(lo.getDefaults(), arguments, ["context"]);
          this.defaultContext
        ...
        toSeconds(t) {
          return new no(this.context, t).toSeconds();
        }
        toFrequency(t) {
          return new oo(this.context, t).toFrequency();
        }
        toTicks(t) {
          return new ho(this.context, t).toTicks();
        }
          ...
          return (
            Object.keys(t).forEach((e) => {
              if (Reflect.has(this, e)) {
                const s = this[e];
                si(s) && si(s.value) && si(s.setValueAtTime)
                  ? (t[e] = s.value)
                  : s instanceof lo
        ...
        set(t) {
          return (
            Object.keys(t).forEach((e) => {
              Reflect.has(this, e) &&
                si(this[e]) &&
                (this[e] && si(this[e].value) && si(this[e].setValueAtTime)
                  ? this[e].value !== t[e] && (this[e].value = t[e])
                  : this[e] instanceof lo
                  ? this[e].set(t[e])
                  : (this[e] = t[e]));
            }),
            this
      ...
      class fo extends lo {
        constructor() {
          super(bi(fo.getDefaults(), arguments, ["param", "units", "convert"])),
            (this.name = "Param"),
            (this.overridden = !1),
            (this._minOutput = 1e-7);
          const t = bi(fo.getDefaults(), arguments, [
            "param",
            "units",
            "convert",
          ]);
          for (
            Xn(
              si(t.param) && (_i(t.param) || t.param instanceof fo),
          ...
          (this._swappable = !!si(t.swappable) && t.swappable),
            this._swappable
              ? ((this.input = this.context.createGain()),
                (this._param = t.param),
                this.input.connect(this._param))
              : (this._param = this.input = t.param),
            (this._events = new Ei(1e3)),
        ...
        _toType(t) {
          return this.convert && "decibels" === this.units ? Hi(t) : t;
        }
        setValueAtTime(t, e) {
      ...
      class _o extends lo {
        ...
        get numberOfInputs() {
          return si(this.input)
            ? _i(this.input) || this.input instanceof fo
              ? 1
              : this.input.numberOfInputs
            : 0;
        }
        get numberOfOutputs() {
          return si(this.output) ? this.output.numberOfOutputs : 0;
        }
        _isAudioNode(t) {
          return si(t) && (t instanceof _o || mi(t));
        }
        _getInternalNodes() {
        ...
        _getChannelProperties() {
          ...
          Xn(t.length > 0, "ToneAudioNode does not have any internal nodes");
          const e = t[0];
          return {
        ...
        toMaster() {
          return (
            ti("toMaster() has been renamed toDestination()"),
            this.toDestination()
          );
        }
        disconnect(t, e = 0, s = 0) {
          return vo(this, t, e, s), this;
        }
        chain(...t) {
          return mo(this, ...t), this;
        }
        fan(...t) {
        ...
        dispose() {
          return (
            super.dispose(),
            si(this.input) &&
              (this.input instanceof _o
                ? this.input.dispose()
                : mi(this.input) && this.input.disconnect()),
            si(this.output) &&
              (this.output instanceof _o
                ? this.output.dispose()
                : mi(this.output) && this.output.disconnect()),
            (this._internalChannels = []),
            this
          );
        }
      ...
      function mo(...t) {
        const e = t.shift();
        t.reduce(
          (t, e) => (t instanceof _o ? t.connect(e) : mi(t) && go(t, e), e),
          e
        );
      }
      function go(t, e, s = 0, n = 0) {
        for (
          Xn(si(t), "Cannot connect from undefined node"),
            Xn(si(e), "Cannot connect to undefined node"),
            (e instanceof _o || mi(e)) &&
              Xn(e.numberOfInputs > 0, "Cannot connect to node with no inputs"),
            Xn(
              t.numberOfOutputs > 0,
              "Cannot connect from node with no outputs"
            );
          e instanceof _o || e instanceof fo;

        )
          si(e.input) && (e = e.input);
        for (; t instanceof _o; ) si(t.output) && (t = t.output);
        _i(e) ? t.connect(e, s) : t.connect(e, s, n);
      }
      function vo(t, e, s = 0, n = 0) {
        if (si(e)) for (; e instanceof _o; ) e = e.input;
        for (; !mi(t); ) si(t.output) && (t = t.output);
        _i(e)
          ? t.disconnect(e, s)
          : mi(e)
          ? t.disconnect(e, s, n)
      ...
      class yo extends _o {
        constructor() {
          super(bi(yo.getDefaults(), arguments, ["gain", "units"])),
            (this.name = "Gain"),
            (this._gainNode = this.context.createGain()),
            (this.input = this._gainNode),
            (this.output = this._gainNode);
          const t = bi(yo.getDefaults(), arguments, ["gain", "units"]);
          (this.gain = new fo({
      ...
      class xo extends _o {
        constructor(t) {
          super(t),
            ...
            (this._stopTime = -1),
            (this._timeout = -1),
            (this.output = new yo({ context: this.context, gain: 0 })),
        ...
        _startGain(t, e = 1) {
          Xn(-1 === this._startTime, "Source cannot be started more than once");
        ...
        _stopGain(t) {
          Xn(-1 !== this._startTime, "'start' must be called before 'stop'"),
            this.cancelStop();
        ...
        cancelStop() {
          return (
            this.log("cancelStop"),
            Xn(-1 !== this._startTime, "Source is not started"),
      ...
      class wo extends xo {
        constructor() {
          super(bi(wo.getDefaults(), arguments, ["offset"])),
            (this.name = "ToneConstantSource"),
            (this._source = this.context.createConstantSource());
          const t = bi(wo.getDefaults(), arguments, ["offset"]);
          go(this._source, this._gainNode),
            (this.offset = new fo({
              context: this.context,
              convert: t.convert,
      ...
      class bo extends _o {
        constructor() {
          super(bi(bo.getDefaults(), arguments, ["value", "units"])),
            (this.name = "Signal"),
            (this.override = !0);
          const t = bi(bo.getDefaults(), arguments, ["value", "units"]);
          (this.output = this._constantSource = new wo({
            context: this.context,
            convert: t.convert,
            offset: t.value,
            units: t.units,
      ...
      function To(t, e, s, n) {
        (e instanceof fo || _i(e) || (e instanceof bo && e.override)) &&
          (e.cancelScheduledValues(0),
          e.setValueAtTime(0, 0),
          e instanceof bo && (e.overridden = !0)),
          go(t, e, s, n);
      }
      class So extends fo {
        constructor() {
          super(bi(So.getDefaults(), arguments, ["value"])),
            (this.name = "TickParam"),
            (this._events = new Ei(1 / 0)),
            (this._multiplier = 1);
          const t = bi(So.getDefaults(), arguments, ["value"]);
      ...
      class ko extends bo {
        constructor() {
          super(bi(ko.getDefaults(), arguments, ["value"])),
            (this.name = "TickSignal");
          const t = bi(ko.getDefaults(), arguments, ["value"]);
          this.input = this._param = new So({
            context: this.context,
            convert: t.convert,
        ...
        static getDefaults() {
          return Object.assign(bo.getDefaults(), {
            multiplier: 1,
            units: "hertz",
            value: 1,
          });
      ...
      class Co extends lo {
        constructor() {
          super(bi(Co.getDefaults(), arguments, ["frequency"])),
            (this.name = "TickSource"),
            (this._state = new po()),
            (this._tickOffset = new Ei());
          const t = bi(Co.getDefaults(), arguments, ["frequency"]);
          (this.frequency = new ko({
            context: this.context,
            units: t.units,
            value: t.frequency,
          })),
      ...
      class Ao extends lo {
        constructor() {
          super(bi(Ao.getDefaults(), arguments, ["callback", "frequency"])),
            (this.name = "Clock"),
            (this.callback = zi),
            (this._lastUpdate = 0),
            (this._state = new po("stopped")),
            (this._boundLoop = this._loop.bind(this));
          const t = bi(Ao.getDefaults(), arguments, ["callback", "frequency"]);
          (this.callback = t.callback),
            (this._tickSource = new Co({
              context: this.context,
      ...
      class Do extends _o {
        constructor() {
          super(bi(Do.getDefaults(), arguments, ["delayTime", "maxDelay"])),
            (this.name = "Delay");
          const t = bi(Do.getDefaults(), arguments, ["delayTime", "maxDelay"]),
        ...
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { delayTime: 0, maxDelay: 1 });
        }
        get maxDelay() {
      ...
      function Oo(t, e, s = 2, n = Qi().sampleRate) {
        return di(this, void 0, void 0, function* () {
          const i = Qi(),
            o = new Wi(s, e, n);
          Zi(o), yield t(o);
      ...
      class Mo extends ki {
        ...
        get(t) {
          return (
            Xn(this.has(t), "ToneAudioBuffers has no buffer named: " + t),
        ...
        add(t, e, s = zi, n = zi) {
          return (
            ci(e)
              ? this._buffers.set(t.toString(), new Bi(this.baseUrl + e, s, n))
              : this._buffers.set(t.toString(), new Bi(e, s, n)),
            this
          );
        }
        dispose() {
      ...
      class Eo extends oo {
        ...
        _frequencyToUnits(t) {
          return Ki(super._frequencyToUnits(t));
        }
        _ticksToUnits(t) {
          return Ki(super._ticksToUnits(t));
        }
        _beatsToUnits(t) {
          return Ki(super._beatsToUnits(t));
        }
        _secondsToUnits(t) {
          return Ki(super._secondsToUnits(t));
        }
        toMidi() {
          return this.valueOf();
        }
        ...
        transpose(t) {
          return new Eo(this.context, this.toMidi() + t);
        }
      }
      function Ro(t, e) {
        return new Eo(Qi(), t, e);
      }
      class qo extends ho {
        constructor() {
      ...
      class Vo extends ki {
        ...
        add(t) {
          Xn(si(t.time), "Events must have a time property"),
            Xn(si(t.duration), "Events must have a duration parameter"),
            (t.time = t.time.valueOf());
          let e = new No(t.time, t.time + t.duration, t);
          for (
      ...
      class Po extends _o {
        constructor() {
          super(bi(Po.getDefaults(), arguments, ["volume"])),
            (this.name = "Volume");
          const t = bi(Po.getDefaults(), arguments, ["volume"]);
          (this.input = this.output = new yo({
            context: this.context,
            gain: t.volume,
            units: "decibels",
          })),
        ...
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { mute: !1, volume: 0 });
        }
        get mute() {
      ...
      class jo extends _o {
        constructor() {
          super(bi(jo.getDefaults(), arguments)),
            (this.name = "Destination"),
            (this.input = new Po({ context: this.context })),
            (this.output = new yo({ context: this.context })),
            (this.volume = this.input.volume);
          const t = bi(jo.getDefaults(), arguments);
          mo(this.input, this.output, this.context.rawContext.destination),
            (this.mute = t.mute),
            (this._internalChannels = [
              this.input,
      ...
      qi((t) => {
        t.destination = new jo({ context: t });
      }),
        Ii((t) => {
      ...
      class Lo extends ki {
        constructor(t) {
          super(),
            ...
            (this._timeline = new Ei({ memory: 10 })),
      ...
      class Bo extends zo {
        constructor(t, e) {
          ...
          const s = Object.assign(Bo.getDefaults(), e);
          (this.duration = new qo(t.context, s.duration).valueOf()),
            (this._interval = new qo(t.context, s.interval).valueOf()),
        ...
        _createEvents(t) {
          ...
          e >= this.time &&
            ...
            (this._nextId = this.transport.scheduleOnce(
              ...
              new qo(this.context, this._nextTick).toSeconds()
            )));
        }
        _restart(t) {
      ...
      class Wo extends lo {
        constructor() {
          super(bi(Wo.getDefaults(), arguments)),
            (this.name = "Transport"),
            (this._loop = new Lo(!1)),
            (this._loopStart = 0),
            (this._loopEnd = 0),
            (this._scheduledEvents = {}),
            (this._timeline = new Ei()),
            (this._repeatedEvents = new Vo()),
            (this._syncedSignals = []),
            (this._swingAmount = 0);
          const t = bi(Wo.getDefaults(), arguments);
          (this._ppq = t.ppq),
            (this._clock = new Ao({
        ...
        _processTick(t, e) {
          if (
            ...
            t +=
              new qo(this.context, (2 * this._swingTicks) / 3).toSeconds() * n;
          }
          this._loop.get(t) &&
            e >= this._loopEnd &&
            (this.emit("loopEnd", t),
        ...
        schedule(t, e) {
          const s = new zo(this, {
            callback: t,
            time: new ho(this.context, e).toTicks(),
          });
        ...
        scheduleRepeat(t, e, s, n = 1 / 0) {
          const i = new Bo(this, {
            callback: t,
            duration: new no(this.context, n).toTicks(),
            interval: new no(this.context, e).toTicks(),
            time: new ho(this.context, s).toTicks(),
          });
        ...
        _bindClockEvents() {
          this._clock.on("start", (t, e) => {
            (e = new qo(this.context, e).toSeconds()), this.emit("start", t, e);
          }),
        ...
        start(t, e) {
          let s;
          return si(e) && (s = this.toTicks(e)), this._clock.start(t, s), this;
        }
        stop(t) {
        ...
        set timeSignature(t) {
          ai(t) && (t = (t[0] / t[1]) * 4), (this._timeSignature = t);
        }
        get loopStart() {
          return new no(this.context, this._loopStart, "i").toSeconds();
        }
        set loopStart(t) {
          this._loopStart = this.toTicks(t);
        }
        get loopEnd() {
          return new no(this.context, this._loopEnd, "i").toSeconds();
        }
        set loopEnd(t) {
        ...
        get swingSubdivision() {
          return new qo(this.context, this._swingTicks).toNotation();
        }
        ...
        get position() {
          ...
          return new qo(this.context, e).toBarsBeatsSixteenths();
        }
        set position(t) {
          const e = this.toTicks(t);
          this.ticks = e;
          ...
          if (this._clock.ticks !== t) {
            ...
            if ("started" === this.state) {
              const s = this._clock.getTicksAtTime(e),
                n = this._clock.getTimeOfTick(Math.ceil(s));
              this.emit("stop", n),
      ...
      class Uo extends _o {
        constructor(t) {
          super(t),
            ...
            (this._volume = this.output = new Po({
              context: this.context,
              mute: t.mute,
              volume: t.volume,
            })),
        ...
        start(t, e, s) {
          ...
          if (
            ...
            if (
              ...
              t &&
                ((t.offset = this.toSeconds(Ti(e, 0))),
            ...
            } else Hn(this.context), this._start(n, e, s);
          else
            Xn(
              Ci(n, this._state.get(n).time),
        ...
        stop(t) {
          ...
          if (
            ...
            "started" === this._state.getValueAtTime(e) ||
              si(this._state.getNextState("started", e)))
          ) {
      ...
      class Go extends xo {
        constructor() {
          super(bi(Go.getDefaults(), arguments, ["url", "onload"])),
            (this.name = "ToneBufferSource"),
            (this._source = this.context.createBufferSource()),
            (this._internalChannels = [this._source]),
            (this._sourceStarted = !1),
            (this._sourceStopped = !1);
          const t = bi(Go.getDefaults(), arguments, ["url", "onload"]);
          go(this._source, this._gainNode),
            (this._source.onended = () => this._stopSource()),
            (this.playbackRate = new fo({
              context: this.context,
            ...
            (this._buffer = new Bi(t.url, t.onload, t.onerror)),
        ...
        start(t, e, s, n = 1) {
          Xn(this.buffer.loaded, "buffer is either not set or not loaded");
          const i = this.toSeconds(t);
          this._startGain(i, n),
            (e = this.loop ? Ti(e, this.loopStart) : Ti(e, 0));
      ...
      class Qo extends Uo {
        constructor() {
          super(bi(Qo.getDefaults(), arguments, ["type"])),
            (this.name = "Noise"),
            (this._source = null);
          const t = bi(Qo.getDefaults(), arguments, ["type"]);
        ...
        set type(t) {
          if (
            (Xn(t in Xo, "Noise: invalid type: " + t),
      ...
      const Zo = { brown: null, pink: null, white: null },
        Xo = {
          get brown() {
            if (!Zo.brown) {
              const t = [];
      ...
      class Yo extends _o {
        constructor() {
          super(bi(Yo.getDefaults(), arguments, ["volume"])),
            (this.name = "UserMedia");
          const t = bi(Yo.getDefaults(), arguments, ["volume"]);
          (this._volume = this.output = new Po({
            context: this.context,
            volume: t.volume,
          })),
        ...
        open(t) {
          return di(this, void 0, void 0, function* () {
            Xn(Yo.supported, "UserMedia is not supported"),
              "started" === this.state && this.close();
            const e = yield Yo.enumerateDevices();
            ii(t)
              ? (this._device = e[t])
              : ((this._device = e.find(
                ...
                Xn(si(this._device), "No matching device " + t));
            const s = {
              audio: {
                echoCancellation: !1,
            ...
            if (!this._stream) {
              ...
              go(t, this.output), (this._mediaStream = t);
            }
            return this;
          });
        }
        ...
        static get supported() {
          return (
            ...
            si(navigator.mediaDevices.getUserMedia)
          );
        }
      }
      function Ho(t, e) {
        return di(this, void 0, void 0, function* () {
          const s = e / t.context.sampleRate,
            n = new Wi(1, s, t.context.sampleRate);
          new t.constructor(
      ...
      class $o extends xo {
        constructor() {
          super(bi($o.getDefaults(), arguments, ["frequency", "type"])),
            (this.name = "ToneOscillatorNode"),
            (this._oscillator = this.context.createOscillator()),
            (this._internalChannels = [this._oscillator]);
          const t = bi($o.getDefaults(), arguments, ["frequency", "type"]);
          go(this._oscillator, this._gainNode),
            (this.type = t.type),
      ...
      class Jo extends Uo {
        constructor() {
          super(bi(Jo.getDefaults(), arguments, ["frequency", "type"])),
            (this.name = "Oscillator"),
            (this._oscillator = null);
          const t = bi(Jo.getDefaults(), arguments, ["frequency", "type"]);
          (this.frequency = new bo({
            context: this.context,
            units: "frequency",
            value: t.frequency,
          })),
        ...
        _getCachedPeriodicWave() {
          if ("custom" === this._type) {
            return Jo._periodicWaveCache.find((t) => {
              return (
                t.phase === this._phase &&
                ((e = t.partials),
                (s = this._partials),
          ...
          {
            const t = Jo._periodicWaveCache.find(
          ...
          if (0 === this._phase && e)
            ...
            if (si(e)) {
              ...
              (this._wave = n),
                ...
                Jo._periodicWaveCache.length > 100 &&
                  Jo._periodicWaveCache.shift();
            }
          }
        }
        get baseType() {
        ...
        getInitialValue() {
          ...
          return Mi(-this._inverseFFT(t, e, this._phase) / s, -1, 1);
        }
        get partials() {
      ...
      Jo._periodicWaveCache = [];
      class Ko extends _o {
        constructor() {
          super(Object.assign(bi(Ko.getDefaults(), arguments, ["context"])));
        }
        connect(t, e = 0, s = 0) {
          return To(this, t, e, s), this;
        }
      ...
      class tr extends Ko {
        constructor() {
          super(
            Object.assign(
              bi(tr.getDefaults(), arguments, ["mapping", "length"])
            )
          ),
          ...
          const t = bi(tr.getDefaults(), arguments, ["mapping", "length"]);
          ai(t.mapping) || t.mapping instanceof Float32Array
            ? (this.curve = Float32Array.from(t.mapping))
            : ni(t.mapping) && this.setMap(t.mapping, t.length);
        }
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { length: 1024 });
        }
        setMap(t, e = 1024) {
      ...
      class sr extends bo {
        constructor() {
          super(Object.assign(bi(sr.getDefaults(), arguments, ["value"]))),
            (this.name = "Multiply"),
            (this.override = !1);
          const t = bi(sr.getDefaults(), arguments, ["value"]);
          (this._mult = this.input = this.output = new yo({
            context: this.context,
            minValue: t.minValue,
            maxValue: t.maxValue,
          })),
        ...
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { value: 0 });
        }
        dispose() {
      ...
      class nr extends Uo {
        constructor() {
          super(
            ...
            (this._modulationScale = new er({ context: this.context })),
            (this._modulationNode = new yo({ context: this.context }));
          const t = bi(nr.getDefaults(), arguments, [
            "frequency",
            "type",
            "modulationType",
          ]);
          (this._carrier = new Jo({
            context: this.context,
            detune: t.detune,
            frequency: t.frequency,
      ...
      class ir extends Uo {
        constructor() {
          super(
            ...
            (this._modulationNode = new yo({ context: this.context, gain: 0 }));
          const t = bi(ir.getDefaults(), arguments, [
            "frequency",
            "type",
            "modulationType",
          ]);
      ...
      class or extends Uo {
        constructor() {
          super(bi(or.getDefaults(), arguments, ["frequency", "width"])),
            (this.name = "PulseOscillator"),
            (this._widthGate = new yo({ context: this.context, gain: 0 })),
            (this._thresh = new tr({
              context: this.context,
              mapping: (t) => (t <= 0 ? -1 : 1),
            }));
          const t = bi(or.getDefaults(), arguments, ["frequency", "width"]);
          (this.width = new bo({
            context: this.context,
            units: "audioRange",
            value: t.width,
          })),
            (this._triangle = new Jo({
              context: this.context,
              detune: t.detune,
              frequency: t.frequency,
              onstop: () => this.onstop(this),
      ...
      class rr extends Uo {
        constructor() {
          super(
            bi(rr.getDefaults(), arguments, ["frequency", "type", "spread"])
          ),
            (this.name = "FatOscillator"),
            (this._oscillators = []);
          const t = bi(rr.getDefaults(), arguments, [
            "frequency",
            "type",
            "spread",
          ]);
        ...
        set count(t) {
          if ((Yn(t, 1), this._oscillators.length !== t)) {
      ...
      class ar extends Uo {
        constructor() {
          ...
          const t = bi(ar.getDefaults(), arguments, [
            "frequency",
            "modulationFrequency",
          ]);
          (this._pulse = new or({
      ...
      class hr extends Uo {
        constructor() {
          super(bi(hr.getDefaults(), arguments, ["frequency", "type"])),
            (this.name = "OmniOscillator");
          const t = bi(hr.getDefaults(), arguments, ["frequency", "type"]);
          (this.frequency = new bo({
            context: this.context,
            units: "frequency",
            value: t.frequency,
      ...
      class ur extends bo {
        constructor() {
          super(Object.assign(bi(ur.getDefaults(), arguments, ["value"]))),
            (this.override = !1),
            (this.name = "Add"),
            (this._sum = new yo({ context: this.context })),
            (this.input = this._sum),
            (this.output = this._sum),
            (this.addend = this._param),
            mo(this._constantSource, this._sum);
        }
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { value: 0 });
        }
      ...
      class lr extends Ko {
        constructor() {
          super(Object.assign(bi(lr.getDefaults(), arguments, ["min", "max"]))),
            (this.name = "Scale");
          const t = bi(lr.getDefaults(), arguments, ["min", "max"]);
          (this._mult = this.input = new sr({
            context: this.context,
            value: t.max - t.min,
          })),
        ...
        static getDefaults() {
          return Object.assign(Ko.getDefaults(), { max: 1, min: 0 });
        }
        get min() {
          return this._min;
        }
      ...
      class pr extends Ko {
        constructor() {
          super(Object.assign(bi(pr.getDefaults(), arguments))),
            (this.name = "Zero"),
            (this._gain = new yo({ context: this.context })),
            (this.output = this._gain),
            (this.input = void 0),
            go(this.context.getConstant(0), this._gain);
        }
        dispose() {
          return (
            super.dispose(), vo(this.context.getConstant(0), this._gain), this
          );
        }
      }
      class dr extends _o {
        constructor() {
          super(bi(dr.getDefaults(), arguments, ["frequency", "min", "max"])),
            (this.name = "LFO"),
            (this._stoppedValue = 0),
            (this._units = "number"),
            (this.convert = !0),
            (this._fromType = fo.prototype._fromType),
            (this._toType = fo.prototype._toType),
            (this._is = fo.prototype._is),
            (this._clampValue = fo.prototype._clampValue);
          const t = bi(dr.getDefaults(), arguments, [
            "frequency",
            "min",
            "max",
          ]);
          (this._oscillator = new Jo({
            context: this.context,
            frequency: t.frequency,
            type: t.type,
          })),
            (this.frequency = this._oscillator.frequency),
            (this._amplitudeGain = new yo({
              context: this.context,
              gain: t.amplitude,
              units: "normalRange",
            })),
            (this.amplitude = this._amplitudeGain.gain),
            (this._stoppedSignal = new bo({
              context: this.context,
              units: "audioRange",
              value: 0,
            })),
            (this._zeros = new pr({ context: this.context })),
            (this._a2g = new er({ context: this.context })),
            (this._scaler = this.output = new lr({
              context: this.context,
              max: t.max,
              min: t.min,
            })),
        ...
        connect(t, e, s) {
          return (
            (t instanceof fo || t instanceof bo) &&
      ...
      function _r(t, e = 1 / 0) {
        ...
        return function (n, i) {
          Reflect.defineProperty(n, i, {
            ...
            set: function (n) {
              Yn(this.toSeconds(n), t, e), s.set(this, n);
            },
          });
        };
      }
      class mr extends Uo {
        constructor() {
          super(bi(mr.getDefaults(), arguments, ["url", "onload"])),
            (this.name = "Player"),
            (this._activeSources = new Set());
          const t = bi(mr.getDefaults(), arguments, ["url", "onload"]);
          (this._buffer = new Bi({
        ...
        _start(t, e, s) {
          e = this._loop ? Ti(e, this._loopStart) : Ti(e, 0);
          let n = this.toSeconds(e);
          this._synced && (n *= this._playbackRate);
          const i = s;
          s = Ti(s, Math.max(this._buffer.duration - n, 0));
        ...
        set loopStart(t) {
          (this._loopStart = t),
            this.buffer.loaded &&
              Yn(this.toSeconds(t), 0, this.buffer.duration),
      ...
      pi([_r(0)], mr.prototype, "fadeIn", void 0),
        pi([_r(0)], mr.prototype, "fadeOut", void 0);
      class gr extends _o {
        constructor() {
          super(bi(gr.getDefaults(), arguments, ["urls", "onload"], "urls")),
            (this.name = "Players"),
            (this.input = void 0),
            (this._players = new Map());
          const t = bi(gr.getDefaults(), arguments, ["urls", "onload"], "urls");
          (this._volume = this.output = new Po({
            context: this.context,
            volume: t.volume,
          })),
      ...
      class vr extends Uo {
        constructor() {
          super(bi(vr.getDefaults(), arguments, ["url", "onload"])),
            (this.name = "GrainPlayer"),
            (this._loopStart = 0),
            (this._loopEnd = 0),
            (this._activeSources = []);
          const t = bi(vr.getDefaults(), arguments, ["url", "onload"]);
          (this.buffer = new Bi({
            onload: t.onload,
            onerror: t.onerror,
            reverse: t.reverse,
        ...
        _start(t, e, s) {
          (e = Ti(e, 0)), (e = this.toSeconds(e)), (t = this.toSeconds(t));
        ...
        _tick(t) {
          ...
          const n = s < this._overlap ? 0 : this._overlap,
            i = new Go({
              ...
              loopStart: this._loopStart,
              loopEnd: this._loopEnd,
              playbackRate: $i(this.detune / 100),
            }).connect(this.output);
        ...
        set loopStart(t) {
          this.buffer.loaded && Yn(this.toSeconds(t), 0, this.buffer.duration),
      ...
      class wr extends Ko {
        constructor() {
          super(...arguments),
            (this.name = "Negate"),
            (this._multiply = new sr({ context: this.context, value: -1 })),
      ...
      class br extends bo {
        constructor() {
          super(Object.assign(bi(br.getDefaults(), arguments, ["value"]))),
            (this.override = !1),
            (this.name = "Subtract"),
            (this._sum = new yo({ context: this.context })),
            (this.input = this._sum),
            (this.output = this._sum),
            (this._neg = new wr({ context: this.context })),
            (this.subtrahend = this._param),
            mo(this._constantSource, this._neg, this._sum);
        }
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { value: 0 });
        }
      ...
      class Tr extends Ko {
        constructor() {
          super(Object.assign(bi(Tr.getDefaults(), arguments))),
            (this.name = "GreaterThanZero"),
            (this._thresh = this.output = new tr({
              context: this.context,
              length: 127,
              mapping: (t) => (t <= 0 ? 0 : 1),
            })),
            (this._scale = this.input = new sr({
              context: this.context,
              value: 1e4,
            })),
      ...
      class Sr extends bo {
        constructor() {
          super(Object.assign(bi(Sr.getDefaults(), arguments, ["value"]))),
            ...
            (this.override = !1);
          const t = bi(Sr.getDefaults(), arguments, ["value"]);
          (this._subtract = this.input = new br({
            context: this.context,
            value: t.value,
          })),
            (this._gtz = this.output = new Tr({ context: this.context })),
      ...
      class kr extends Ko {
        constructor() {
          super(Object.assign(bi(kr.getDefaults(), arguments, ["value"]))),
            (this.name = "Pow");
          const t = bi(kr.getDefaults(), arguments, ["value"]);
          (this._exponentScaler = this.input = this.output = new tr({
            context: this.context,
        ...
        static getDefaults() {
          return Object.assign(Ko.getDefaults(), { value: 1 });
        }
        _expFunc(t) {
      ...
      class Cr extends lr {
        constructor() {
          super(
            Object.assign(
              bi(Cr.getDefaults(), arguments, ["min", "max", "exponent"])
            )
          ),
            (this.name = "ScaleExp");
          const t = bi(Cr.getDefaults(), arguments, ["min", "max", "exponent"]);
          (this.input = this._exp = new kr({
            context: this.context,
            value: t.exponent,
          })),
        ...
        static getDefaults() {
          return Object.assign(lr.getDefaults(), { exponent: 1 });
        }
        get exponent() {
      ...
      class Ar extends bo {
        constructor() {
          ...
          (this._lastVal = t.value),
            ...
            (this._constantSource = this.output = new wo({
              context: this.context,
              offset: t.value,
              units: t.units,
            }).start(0)),
        ...
        getValueAtTime(t) {
          const e = new ho(this.context, t).toSeconds();
          return super.getValueAtTime(e);
        }
        setValueAtTime(t, e) {
          const s = new ho(this.context, e).toSeconds();
        ...
        setTargetAtTime(t, e, s) {
          const n = new ho(this.context, e).toSeconds();
        ...
        exponentialRampTo(t, e, s) {
          const n = new ho(this.context, s).toSeconds();
      ...
      class Dr extends _o {
        constructor() {
          super(
            ...
            (this.name = "Envelope"),
            (this._sig = new bo({ context: this.context, value: 0 })),
        ...
        _getCurve(t, e) {
          ...
          {
            let s;
            for (s in Or) if (Or[s][e] === t) return s;
            return t;
          }
        }
        _setCurve(t, e, s) {
          if (ci(s) && Reflect.has(Or, s)) {
            const n = Or[s];
            oi(n) ? "_decayCurve" !== t && (this[t] = n[e]) : (this[t] = n);
          } else {
            if (!ai(s) || "_decayCurve" === t)
        ...
        asArray(t = 1024) {
          return di(this, void 0, void 0, function* () {
            const e = t / this.context.sampleRate,
              s = new Wi(1, e, this.context.sampleRate),
      ...
      pi([_r(0)], Dr.prototype, "attack", void 0),
        pi([_r(0)], Dr.prototype, "decay", void 0),
        pi([fr(0, 1)], Dr.prototype, "sustain", void 0),
        pi([_r(0)], Dr.prototype, "release", void 0);
      const Or = (() => {
        let t, e;
        const s = [];
      ...
      class Mr extends _o {
        constructor() {
          super(bi(Mr.getDefaults(), arguments)),
            (this._scheduledEvents = []),
            (this._synced = !1),
            (this._original_triggerAttack = this.triggerAttack),
            (this._original_triggerRelease = this.triggerRelease);
          const t = bi(Mr.getDefaults(), arguments);
          (this._volume = this.output = new Po({
            context: this.context,
            volume: t.volume,
          })),
        ...
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { volume: 0 });
        }
        sync() {
          return (
            this._syncState() &&
      ...
      class Er extends Mr {
        constructor() {
          super(bi(Er.getDefaults(), arguments));
          const t = bi(Er.getDefaults(), arguments);
        ...
        setNote(t, e) {
          const s = this.toSeconds(e),
            n = t instanceof oo ? t.toFrequency() : t;
      ...
      pi([_r(0)], Er.prototype, "portamento", void 0);
      class Rr extends Dr {
        constructor() {
          super(
            bi(Rr.getDefaults(), arguments, [
              "attack",
              "decay",
              "sustain",
              "release",
            ...
            (this._gainNode = new yo({ context: this.context, gain: 0 })),
            (this.output = this._gainNode),
            (this.input = this._gainNode),
      ...
      class qr extends Er {
        constructor() {
          super(bi(qr.getDefaults(), arguments)), (this.name = "Synth");
          const t = bi(qr.getDefaults(), arguments);
          (this.oscillator = new hr(
            Object.assign(
              {
                context: this.context,
                detune: t.detune,
        ...
        static getDefaults() {
          return Object.assign(Er.getDefaults(), {
            envelope: Object.assign(
              Si(Dr.getDefaults(), Object.keys(_o.getDefaults())),
              { attack: 0.005, decay: 0.1, release: 1, sustain: 0.3 }
            ),
            oscillator: Object.assign(
              Si(hr.getDefaults(), [
                ...Object.keys(Uo.getDefaults()),
                "frequency",
                "detune",
              ]),
              { type: "triangle" }
      ...
      class Fr extends Er {
        constructor() {
          super(bi(Fr.getDefaults(), arguments)),
            (this.name = "ModulationSynth");
          const t = bi(Fr.getDefaults(), arguments);
          (this._carrier = new qr({
            context: this.context,
      ...
      class Ir extends Fr {
        constructor() {
          super(bi(Ir.getDefaults(), arguments)),
            (this.name = "AMSynth"),
            (this._modulationScale = new er({ context: this.context })),
            this.frequency.connect(this._carrier.frequency),
            this.frequency.chain(this.harmonicity, this._modulator.frequency),
      ...
      class Vr extends _o {
        constructor() {
          super(bi(Vr.getDefaults(), arguments, ["frequency", "type"])),
            (this.name = "BiquadFilter");
          const t = bi(Vr.getDefaults(), arguments, ["frequency", "type"]);
      ...
      class Nr extends _o {
        constructor() {
          super(
            bi(Nr.getDefaults(), arguments, ["frequency", "type", "rolloff"])
          ),
            (this.name = "Filter"),
            (this.input = new yo({ context: this.context })),
            (this.output = new yo({ context: this.context })),
            (this._filters = []);
          const t = bi(Nr.getDefaults(), arguments, [
            "frequency",
          ...
          (this._filters = []),
            ...
            ji(this, ["detune", "frequency", "gain", "Q"]);
        }
        static getDefaults() {
          return Object.assign(_o.getDefaults(), {
            Q: 1,
        ...
        set rolloff(t) {
          const e = ii(t) ? t : parseInt(t, 10),
            s = [-12, -24, -48, -96];
          let n = s.indexOf(e);
          Xn(-1 !== n, "rolloff can only be " + s.join(", ")),
            (n += 1),
            (this._rolloff = e),
            this.input.disconnect(),
          ...
          for (let t = 0; t < n; t++) {
            const e = new Vr({ context: this.context });
            (e.type = this._type),
          ...
          (this._internalChannels = this._filters),
            mo(this.input, ...this._internalChannels, this.output);
        }
        getFrequencyResponse(t = 128) {
          const e = new Vr({
        ...
        dispose() {
          return (
            ...
            Li(this, ["detune", "frequency", "gain", "Q"]),
            this.frequency.dispose(),
            this.Q.dispose(),
            this.detune.dispose(),
            this.gain.dispose(),
      ...
      class Pr extends Dr {
        constructor() {
          ...
          const t = bi(Pr.getDefaults(), arguments, [
            "attack",
            "decay",
            "sustain",
            "release",
          ...
          (this._octaves = t.octaves),
            ...
            (this._exponent = this.input = new kr({
              context: this.context,
              value: t.exponent,
            })),
            (this._scale = this.output = new lr({
              context: this.context,
        ...
        static getDefaults() {
          return Object.assign(Dr.getDefaults(), {
            baseFrequency: 200,
            exponent: 1,
            octaves: 4,
          });
      ...
      class jr extends Er {
        constructor() {
          super(bi(jr.getDefaults(), arguments)), (this.name = "MonoSynth");
          const t = bi(jr.getDefaults(), arguments);
          (this.oscillator = new hr(
        ...
        static getDefaults() {
          return Object.assign(Er.getDefaults(), {
            ...
            filter: Object.assign(
              Si(Nr.getDefaults(), Object.keys(_o.getDefaults())),
              { Q: 1, rolloff: -12, type: "lowpass" }
            ),
            filterEnvelope: Object.assign(
              Si(Pr.getDefaults(), Object.keys(_o.getDefaults())),
              {
                attack: 0.6,
                baseFrequency: 200,
                decay: 0.2,
            ...
            oscillator: Object.assign(
              Si(hr.getDefaults(), Object.keys(Uo.getDefaults())),
              { type: "sawtooth" }
            ),
          });
        }
      ...
      class Lr extends Er {
        constructor() {
          super(bi(Lr.getDefaults(), arguments)), (this.name = "DuoSynth");
          const t = bi(Lr.getDefaults(), arguments);
          (this.voice0 = new jr(
        ...
        static getDefaults() {
          return wi(Er.getDefaults(), {
            vibratoAmount: 0.5,
            vibratoRate: 5,
            harmonicity: 1.5,
            voice0: wi(Si(jr.getDefaults(), Object.keys(Er.getDefaults())), {
              filterEnvelope: {
                attack: 0.01,
                decay: 0,
                sustain: 1,
            ...
            voice1: wi(Si(jr.getDefaults(), Object.keys(Er.getDefaults())), {
              filterEnvelope: {
                attack: 0.01,
                decay: 0,
                sustain: 1,
      ...
      class zr extends Fr {
        constructor() {
          super(bi(zr.getDefaults(), arguments)), (this.name = "FMSynth");
          const t = bi(zr.getDefaults(), arguments);
          (this.modulationIndex = new sr({
            context: this.context,
            value: t.modulationIndex,
          })),
        ...
        static getDefaults() {
          return Object.assign(Fr.getDefaults(), { modulationIndex: 10 });
        }
        dispose() {
          return super.dispose(), this.modulationIndex.dispose(), this;
        }
      }
      const Br = [1, 1.483, 1.932, 2.546, 2.63, 3.897];
      class Wr extends Er {
        constructor() {
          super(bi(Wr.getDefaults(), arguments)),
            (this.name = "MetalSynth"),
            (this._oscillators = []),
            (this._freqMultipliers = []);
          const t = bi(Wr.getDefaults(), arguments);
          (this.detune = new bo({
            context: this.context,
            units: "cents",
            value: t.detune,
            ...
            (this._amplitude = new yo({
              context: this.context,
              gain: 0,
            }).connect(this.output)),
            (this._highpass = new Nr({
              Q: 0,
              context: this.context,
              type: "highpass",
          ...
          for (let e = 0; e < Br.length; e++) {
            ...
            const n = new sr({ context: this.context, value: Br[e] });
            (this._freqMultipliers[e] = n),
              this.frequency.chain(n, s.frequency),
              this.detune.connect(s.detune);
          }
          (this._filterFreqScaler = new lr({
            context: this.context,
            max: 7e3,
            min: this.toFrequency(t.resonance),
          })),
            (this.envelope = new Dr({
      ...
      class Ur extends qr {
        constructor() {
          super(bi(Ur.getDefaults(), arguments)),
            (this.name = "MembraneSynth"),
            (this.portamento = 0);
          const t = bi(Ur.getDefaults(), arguments);
          (this.pitchDecay = t.pitchDecay),
            (this.octaves = t.octaves),
            ji(this, ["oscillator", "envelope"]);
        }
        static getDefaults() {
          return wi(Er.getDefaults(), qr.getDefaults(), {
            envelope: {
              attack: 0.001,
        ...
        setNote(t, e) {
          const s = this.toSeconds(e),
            n = this.toFrequency(t instanceof oo ? t.toFrequency() : t),
            i = n * this.octaves;
          return (
      ...
      pi([fr(0)], Ur.prototype, "octaves", void 0),
        pi([_r(0)], Ur.prototype, "pitchDecay", void 0);
      class Gr extends Mr {
        constructor() {
          super(bi(Gr.getDefaults(), arguments)), (this.name = "NoiseSynth");
          const t = bi(Gr.getDefaults(), arguments);
          (this.noise = new Qo(
        ...
        static getDefaults() {
          return Object.assign(Mr.getDefaults(), {
            ...
            noise: Object.assign(
              Si(Qo.getDefaults(), Object.keys(Uo.getDefaults())),
              { type: "white" }
            ),
          });
        }
      ...
      class Hr extends Yr {
        constructor() {
          super(bi(Hr.getDefaults(), arguments, ["delayTime", "resonance"])),
            (this.name = "FeedbackCombFilter");
          const t = bi(Hr.getDefaults(), arguments, ["delayTime", "resonance"]);
          (this.input = new yo({ context: this.context })),
            (this.output = new yo({ context: this.context })),
            (this.delayTime = new fo({
              context: this.context,
      ...
      class $r extends _o {
        constructor() {
          super(bi($r.getDefaults(), arguments, ["frequency", "type"])),
            (this.name = "OnePoleFilter");
          const t = bi($r.getDefaults(), arguments, ["frequency", "type"]);
      ...
      class Jr extends _o {
        constructor() {
          ...
          (this._combFilter = this.output = new Hr({
            context: this.context,
            ...
            (this._lowpass = this.input = new $r({
              context: this.context,
      ...
      class Kr extends Mr {
        constructor() {
          super(bi(Kr.getDefaults(), arguments)), (this.name = "PluckSynth");
          const t = bi(Kr.getDefaults(), arguments);
          (this._noise = new Qo({ context: this.context, type: "pink" })),
      ...
      class ta extends Mr {
        constructor() {
          super(bi(ta.getDefaults(), arguments, ["voice", "options"])),
            (this.name = "PolySynth"),
          ...
          const t = bi(ta.getDefaults(), arguments, ["voice", "options"]);
          Xn(
            !ii(t.voice),
        ...
        _triggerAttack(t, e, s) {
          t.forEach((t) => {
            const n = new Eo(this.context, t).toMidi(),
        ...
        _triggerRelease(t, e) {
          t.forEach((t) => {
            const s = new Eo(this.context, t).toMidi(),
        ...
        _scheduleEvent(t, e, s, n) {
          Xn(!this.disposed, "Synth was already disposed"),
            s <= this.now()
              ? "attack" === t
        ...
        triggerAttackRelease(t, e, s, n) {
          const i = this.toSeconds(s);
          if ((this.triggerAttack(t, i, n), ai(e))) {
            Xn(
              ai(t),
            ...
            for (let s = 0; s < t.length; s++) {
              const n = e[Math.min(s, e.length - 1)],
                o = this.toSeconds(n);
              Xn(o > 0, "The duration must be greater than 0"),
                this.triggerRelease(t[s], i + o);
            }
          } else {
            const s = this.toSeconds(e);
            Xn(s > 0, "The duration must be greater than 0"),
        ...
        set(t) {
          const e = Si(t, ["onsilence", "context"]);
          return (
            (this.options = wi(this.options, e)),
      ...
      class ea extends Mr {
        constructor() {
          ...
          Object.keys(t.urls).forEach((s) => {
            ...
            if (
              (Xn(
                hi(s) || (ii(n) && isFinite(n)),
                "url key is neither a note or midi pitch: " + s
              ),
              hi(s))
            ) {
              const n = new oo(this.context, s).toMidi();
              e[n] = t.urls[s];
            } else ii(n) && isFinite(n) && (e[n] = t.urls[n]);
          }),
            (this._buffers = new Mo({
              urls: e,
              onload: t.onload,
        ...
        triggerAttack(t, e, s = 1) {
          return (
            ...
            Array.isArray(t) || (t = [t]),
            t.forEach((t) => {
              const n = to(new oo(this.context, t).toFrequency()),
                i = Math.round(n),
                o = n - i,
        ...
        triggerRelease(t, e) {
          return (
            ...
            Array.isArray(t) || (t = [t]),
            t.forEach((t) => {
              const s = new oo(this.context, t).toMidi();
              if (
        ...
        triggerAttackRelease(t, e, s, n = 1) {
          ...
          return (
            ...
            ai(e)
              ? (Xn(ai(t), "notes must be an array when duration is array"),
                t.forEach((t, s) => {
                  const n = e[Math.min(s, e.length - 1)];
        ...
        add(t, e, s) {
          if (
            (Xn(hi(t) || isFinite(t), "note must be a pitch or midi: " + t),
            hi(t))
          ) {
            const n = new oo(this.context, t).toMidi();
      ...
      pi([_r(0)], ea.prototype, "attack", void 0),
        pi([_r(0)], ea.prototype, "release", void 0);
      class sa extends lo {
        constructor() {
          super(bi(sa.getDefaults(), arguments, ["callback", "value"])),
            (this.name = "ToneEvent"),
            (this._state = new po("stopped")),
            (this._startOffset = 0);
          const t = bi(sa.getDefaults(), arguments, ["callback", "value"]);
          (this._loop = t.loop),
            (this.callback = t.callback),
            (this.value = t.value),
        ...
        _rescheduleEvents(t = -1) {
          this._state.forEachFrom(t, (t) => {
            ...
            if ("started" === t.state) {
              ...
              if (!0 === this._loop || (ii(this._loop) && this._loop > 1)) {
                (e = 1 / 0),
                  ii(this._loop) && (e = this._loop * this._getLoopDuration());
                ...
                null !== n && (e = Math.min(e, n.time - s)),
                  e !== 1 / 0 &&
                    ...
                    (e = new qo(this.context, e)));
                const i = new qo(this.context, this._getLoopDuration());
                t.id = this.context.transport.scheduleRepeat(
                  this._tick.bind(this),
                  i,
                  new qo(this.context, s),
                  e
                );
              } else
        ...
        _tick(t) {
          ...
          if (!this.mute && "started" === this._state.getValueAtTime(e)) {
            ...
            if (this.humanize) {
              let e = 0.02;
              ri(this.humanize) || (e = this.toSeconds(this.humanize)),
                (t += (2 * Math.random() - 1) * e);
            }
        ...
        get loopEnd() {
          return new qo(this.context, this._loopEnd).toSeconds();
        }
        set loopEnd(t) {
          (this._loopEnd = this.toTicks(t)),
        ...
        get loopStart() {
          return new qo(this.context, this._loopStart).toSeconds();
        }
        set loopStart(t) {
          (this._loopStart = this.toTicks(t)),
            this._loop && this._rescheduleEvents();
      ...
      class na extends lo {
        constructor() {
          super(bi(na.getDefaults(), arguments, ["callback", "interval"])),
            (this.name = "Loop");
          const t = bi(na.getDefaults(), arguments, ["callback", "interval"]);
          (this._event = new sa({
            context: this.context,
            callback: this._tick.bind(this),
            loop: !0,
      ...
      class ia extends sa {
        constructor() {
          super(bi(ia.getDefaults(), arguments, ["callback", "events"])),
            (this.name = "Part"),
            (this._state = new po("stopped")),
            (this._events = new Set());
          const t = bi(ia.getDefaults(), arguments, ["callback", "events"]);
          (this._state.increasing = !0),
            t.events.forEach((t) => {
              ai(t) ? this.add(t[0], t[1]) : this.add(t);
            });
        }
        static getDefaults() {
          return Object.assign(sa.getDefaults(), { events: [] });
        }
        start(t, e) {
          const s = this.toTicks(t);
          if ("started" !== this._state.getValueAtTime(s)) {
            (e = Ti(e, this._loop ? this._loopStart : 0)),
              (e = this._loop ? Ti(e, this._loopStart) : Ti(e, 0));
            ...
            this._loop
              ? t.startOffset >= this._loopStart &&
                ...
                ? (t.startOffset < s && (e += this._getLoopDuration()),
                  t.start(new qo(this.context, e)))
                : t.startOffset < this._loopStart &&
                  t.startOffset >= s &&
                  ((t.loop = !1), t.start(new qo(this.context, e)))
              : t.startOffset >= s && t.start(new qo(this.context, e));
        }
        get startOffset() {
          return this._startOffset;
        }
        ...
        at(t, e) {
          const s = new ho(this.context, t).toTicks(),
            n = new qo(this.context, 1).toSeconds(),
            i = this._events.values();
          let o = i.next();
          for (; !o.done; ) {
            const t = o.value;
            if (Math.abs(s - t.startOffset) < n)
              return si(e) && (t.value = e), t;
            o = i.next();
          }
          return si(e) ? (this.add(t, e), this.at(t)) : null;
        }
        add(t, e) {
        ...
        _restartEvent(t) {
          this._state.forEach((e) => {
            "started" === e.state
              ...
              : t.stop(new qo(this.context, e.time));
          });
        }
        remove(t, e) {
          return (
            oi(t) && t.hasOwnProperty("time") && (t = (e = t).time),
            (t = this.toTicks(t)),
          ...
          return (
            this._events &&
              this._events.forEach((e) => {
                e instanceof ia ? e._forEach(t) : t(e);
              }),
            this
          );
        }
      ...
      function* oa(t) {
        let e = 0;
        for (; e < t.length; ) (e = ca(e, t)), yield t[e], e++;
      }
      function* ra(t) {
        let e = t.length - 1;
        for (; e >= 0; ) (e = ca(e, t)), yield t[e], e--;
      }
      function* aa(t, e) {
        for (;;) yield* e(t);
      }
      function ca(t, e) {
        return Mi(t, 0, e.length - 1);
      }
      function* ha(t, e) {
      ...
      function* ua(t) {
        let e = 0,
          s = 0;
        for (; e < t.length; )
          (e = ca(e, t)), yield t[e], s++, (e += s % 2 ? 2 : -1);
      }
      function* la(t) {
        let e = t.length - 1,
          s = 0;
        for (; e >= 0; ) (e = ca(e, t)), yield t[e], s++, (e += s % 2 ? -2 : 1);
      }
      function* pa(t) {
        const e = [];
        for (let s = 0; s < t.length; s++) e.push(s);
        for (; e.length > 0; ) {
          const s = ca(e.splice(Math.floor(e.length * Math.random()), 1)[0], t);
          yield t[s];
        }
      }
      function* da(t, e = "up", s = 0) {
        switch (
          (Xn(t.length > 0, "The array must have more than one value in it"), e)
        ) {
          case "up":
            yield* aa(t, oa);
          case "down":
      ...
      class fa extends na {
        constructor() {
          super(
            bi(fa.getDefaults(), arguments, ["callback", "values", "pattern"])
          ),
            (this.name = "Pattern");
          const t = bi(fa.getDefaults(), arguments, [
            "callback",
            "values",
            "pattern",
          ]);
          (this.callback = t.callback),
            ...
            (this._pattern = da(t.values, t.pattern)),
        ...
        set pattern(t) {
          (this._type = t), (this._pattern = da(this._values, this._type));
        }
      }
      class _a extends sa {
        constructor() {
          super(
            bi(_a.getDefaults(), arguments, [
              "callback",
              "events",
              "subdivision",
            ])
            ...
            (this._events = []),
            (this._eventsArray = []);
          const t = bi(_a.getDefaults(), arguments, [
            "callback",
            "events",
            "subdivision",
          ]);
        ...
        static getDefaults() {
          return Object.assign(Si(sa.getDefaults(), ["value"]), {
            events: [],
            loop: !0,
            loopEnd: 0,
            loopStart: 0,
        ...
        get subdivision() {
          return new qo(this.context, this._subdivision).toSeconds();
        }
        _createSequence(t) {
          return new Proxy(t, {
            get: (t, e) => t[e],
            set: (t, e, s) => (
              ci(e) && isFinite(parseInt(e, 10)) && ai(s)
        ...
        _rescheduleSequence(t, e, s) {
          t.forEach((t, n) => {
            const i = n * e + s;
            if (ai(t)) this._rescheduleSequence(t, e / t.length, i);
            else {
              const e = new qo(this.context, i, "i").toSeconds();
              this._part.add(e, t);
            }
          });
        }
      ...
      class ma extends _o {
        constructor() {
          super(Object.assign(bi(ma.getDefaults(), arguments, ["fade"]))),
            (this.name = "CrossFade"),
            (this._panner = this.context.createStereoPanner()),
            (this._split = this.context.createChannelSplitter(2)),
            (this._g2a = new xr({ context: this.context })),
            (this.a = new yo({ context: this.context, gain: 0 })),
            (this.b = new yo({ context: this.context, gain: 0 })),
            (this.output = new yo({ context: this.context })),
            (this._internalChannels = [this.a, this.b]);
          const t = bi(ma.getDefaults(), arguments, ["fade"]);
          (this.fade = new bo({
            context: this.context,
            units: "normalRange",
            value: t.fade,
            ...
            go(this._split, this.a.gain, 0),
            go(this._split, this.b.gain, 1),
            this.fade.chain(this._g2a, this._panner.pan),
            this.a.connect(this.output),
            this.b.connect(this.output);
        }
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { fade: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class ga extends _o {
        constructor(t) {
          super(t),
            (this.name = "Effect"),
            (this._dryWet = new ma({ context: this.context })),
            (this.wet = this._dryWet.fade),
            (this.effectSend = new yo({ context: this.context })),
            (this.effectReturn = new yo({ context: this.context })),
            (this.input = new yo({ context: this.context })),
        ...
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { wet: 1 });
        }
        connectEffect(t) {
          return (
      ...
      class ya extends va {
        constructor() {
          ...
          const t = bi(ya.getDefaults(), arguments, [
            "frequency",
            "baseFrequency",
            "octaves",
          ]);
      ...
      class xa extends _o {
        constructor() {
          super(Object.assign(bi(xa.getDefaults(), arguments, ["pan"]))),
            (this.name = "Panner"),
            (this._panner = this.context.createStereoPanner()),
            (this.input = this._panner),
            (this.output = this._panner);
          const t = bi(xa.getDefaults(), arguments, ["pan"]);
          (this.pan = new fo({
            context: this.context,
        ...
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { pan: 0, channelCount: 1 });
        }
        dispose() {
          return (
      ...
      class wa extends va {
        constructor() {
          super(bi(wa.getDefaults(), arguments, ["frequency"])),
            (this.name = "AutoPanner");
          const t = bi(wa.getDefaults(), arguments, ["frequency"]);
          (this._panner = new xa({
            context: this.context,
        ...
        static getDefaults() {
          return Object.assign(va.getDefaults(), { channelCount: 1 });
        }
        dispose() {
      ...
      class ba extends _o {
        constructor() {
          super(bi(ba.getDefaults(), arguments, ["smoothing"])),
            (this.name = "Follower");
          const t = bi(ba.getDefaults(), arguments, ["smoothing"]);
          (this._abs = this.input = new yr({ context: this.context })),
            (this._lowpass = this.output = new $r({
              context: this.context,
        ...
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { smoothing: 0.05 });
        }
        get smoothing() {
      ...
      class Ta extends ga {
        constructor() {
          super(
            ...
            (this.name = "AutoWah");
          const t = bi(Ta.getDefaults(), arguments, [
            "baseFrequency",
            "octaves",
            "sensitivity",
          ]);
          (this._follower = new ba({
            context: this.context,
            smoothing: t.follower,
          })),
            (this._sweepRange = new Cr({
              context: this.context,
              min: 0,
              max: 1,
              exponent: 0.5,
            ...
            (this._baseFrequency = this.toFrequency(t.baseFrequency)),
            (this._octaves = t.octaves),
            (this._inputBoost = new yo({ context: this.context })),
            (this._bandpass = new Nr({
              context: this.context,
              rolloff: -48,
              frequency: 0,
              Q: t.Q,
            })),
            (this._peaking = new Nr({
              context: this.context,
              type: "peaking",
            })),
        ...
        set sensitivity(t) {
          this._inputBoost.gain.value = 1 / Yi(t);
        }
        _setSweepRange() {
      ...
      class Sa extends ga {
        constructor() {
          super(bi(Sa.getDefaults(), arguments, ["bits"])),
            (this.name = "BitCrusher");
          const t = bi(Sa.getDefaults(), arguments, ["bits"]);
          (this._bitCrusherWorklet = new ka({
            context: this.context,
            bits: t.bits,
          })),
        ...
        static getDefaults() {
          return Object.assign(ga.getDefaults(), { bits: 4 });
        }
        dispose() {
      ...
      class ka extends Yr {
        constructor() {
          super(bi(ka.getDefaults(), arguments)),
            (this.name = "BitCrusherWorklet");
          const t = bi(ka.getDefaults(), arguments);
          (this.input = new yo({ context: this.context })),
            (this.output = new yo({ context: this.context })),
            (this.bits = new fo({
              context: this.context,
        ...
        static getDefaults() {
          return Object.assign(Yr.getDefaults(), { bits: 12 });
        }
        _audioWorkletName() {
          return "bit-crusher";
        }
      ...
      class Ca extends ga {
        constructor() {
          super(bi(Ca.getDefaults(), arguments, ["order"])),
            (this.name = "Chebyshev");
          const t = bi(Ca.getDefaults(), arguments, ["order"]);
          (this._shaper = new tr({ context: this.context, length: 4096 })),
            (this._order = t.order),
      ...
      class Aa extends _o {
        constructor() {
          super(bi(Aa.getDefaults(), arguments, ["channels"])),
            (this.name = "Split");
          const t = bi(Aa.getDefaults(), arguments, ["channels"]);
          (this._splitter = this.input = this.output = this.context.createChannelSplitter(
            t.channels
          )),
            (this._internalChannels = [this._splitter]);
        }
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { channels: 2 });
        }
        dispose() {
      ...
      class Da extends _o {
        constructor() {
          super(bi(Da.getDefaults(), arguments, ["channels"])),
            (this.name = "Merge");
          const t = bi(Da.getDefaults(), arguments, ["channels"]);
          this._merger = this.output = this.input = this.context.createChannelMerger(
            t.channels
          );
        }
        static getDefaults() {
      ...
      class Oa extends _o {
        constructor(t) {
          super(t),
            ...
            (this._dryWet = this.output = new ma({
              context: this.context,
              fade: t.wet,
            })),
            (this.wet = this._dryWet.fade),
            (this._split = new Aa({ context: this.context, channels: 2 })),
            (this._merge = new Da({ context: this.context, channels: 2 })),
        ...
        connectEffectLeft(...t) {
          this._split.connect(t[0], 0, 0),
            mo(...t),
            go(t[t.length - 1], this._merge, 0, 0);
        }
        connectEffectRight(...t) {
          this._split.connect(t[0], 1, 0),
            mo(...t),
            go(t[t.length - 1], this._merge, 0, 1);
        }
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { wet: 1 });
        }
      ...
      class Ma extends Oa {
        constructor(t) {
          super(t),
            (this.feedback = new bo({
              context: this.context,
              value: t.feedback,
              units: "normalRange",
            })),
            (this._feedbackL = new yo({ context: this.context })),
            (this._feedbackR = new yo({ context: this.context })),
            (this._feedbackSplit = new Aa({
              context: this.context,
              channels: 2,
            })),
            (this._feedbackMerge = new Da({
              context: this.context,
              channels: 2,
            })),
        ...
        static getDefaults() {
          return Object.assign(Oa.getDefaults(), { feedback: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class Ea extends Ma {
        constructor() {
          super(
            bi(Ea.getDefaults(), arguments, ["frequency", "delayTime", "depth"])
          ),
            (this.name = "Chorus");
          const t = bi(Ea.getDefaults(), arguments, [
            "frequency",
            "delayTime",
            "depth",
          ]);
          (this._depth = t.depth),
            ...
            (this._delayNodeL = new Do({ context: this.context })),
            (this._delayNodeR = new Do({ context: this.context })),
      ...
      class Ra extends ga {
        constructor() {
          super(bi(Ra.getDefaults(), arguments, ["distortion"])),
            (this.name = "Distortion");
          const t = bi(Ra.getDefaults(), arguments, ["distortion"]);
          (this._shaper = new tr({ context: this.context, length: 4096 })),
      ...
      class qa extends ga {
        ...
        static getDefaults() {
          return Object.assign(ga.getDefaults(), { feedback: 0.125 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class Fa extends qa {
        constructor() {
          super(bi(Fa.getDefaults(), arguments, ["delayTime", "feedback"])),
            (this.name = "FeedbackDelay");
          const t = bi(Fa.getDefaults(), arguments, ["delayTime", "feedback"]);
          (this._delayNode = new Do({
            context: this.context,
            delayTime: t.delayTime,
            maxDelay: t.maxDelay,
          })),
      ...
      class Ia extends _o {
        constructor(t) {
          super(t),
            ...
            (this.input = new yo({ context: this.context })),
            (this.output = new yo({ context: this.context })),
            (this.offset90 = new yo({ context: this.context }));
          (this._bank0 = this._createAllPassFilterBank([
            ...
            mo(this.input, ...this._bank0, this._oneSampleDelay, this.output),
            mo(this.input, ...this._bank1, this.offset90);
        }
      ...
      class Va extends ga {
        constructor() {
          super(bi(Va.getDefaults(), arguments, ["frequency"])),
            (this.name = "FrequencyShifter");
          const t = bi(Va.getDefaults(), arguments, ["frequency"]);
          (this.frequency = new bo({
            context: this.context,
            units: "frequency",
            value: t.frequency,
            ...
            (this._sine = new $o({ context: this.context, type: "sine" })),
            (this._cosine = new Jo({
              context: this.context,
              phase: -90,
              type: "sine",
            })),
            (this._sineMultiply = new sr({ context: this.context })),
            (this._cosineMultiply = new sr({ context: this.context })),
            (this._negate = new wr({ context: this.context })),
            (this._add = new ur({ context: this.context })),
            (this._phaseShifter = new Ia({ context: this.context })),
        ...
        static getDefaults() {
          return Object.assign(ga.getDefaults(), { frequency: 0 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class ja extends Oa {
        constructor() {
          super(bi(ja.getDefaults(), arguments, ["roomSize", "dampening"])),
            (this.name = "Freeverb"),
            (this._combFilters = []),
            (this._allpassFiltersL = []),
            (this._allpassFiltersR = []);
          const t = bi(ja.getDefaults(), arguments, ["roomSize", "dampening"]);
          (this.roomSize = new bo({
            context: this.context,
            value: t.roomSize,
            units: "normalRange",
          })),
            (this._allpassFiltersL = Pa.map((t) => {
              const e = this.context.createBiquadFilter();
              return (e.type = "allpass"), (e.frequency.value = t), e;
            })),
            (this._allpassFiltersR = Pa.map((t) => {
              const e = this.context.createBiquadFilter();
              return (e.type = "allpass"), (e.frequency.value = t), e;
            })),
            (this._combFilters = Na.map((e, s) => {
              const n = new Jr({
                context: this.context,
                dampening: t.dampening,
                delayTime: e,
        ...
        static getDefaults() {
          return Object.assign(Oa.getDefaults(), {
            roomSize: 0.7,
            dampening: 3e3,
          });
        }
      ...
      const La = [0.06748, 0.06404, 0.08212, 0.09004],
        za = [0.773, 0.802, 0.753, 0.733],
        Ba = [347, 113, 37];
      class Wa extends Oa {
        constructor() {
          super(bi(Wa.getDefaults(), arguments, ["roomSize"])),
            (this.name = "JCReverb"),
            (this._allpassFilters = []),
            (this._feedbackCombFilters = []);
          const t = bi(Wa.getDefaults(), arguments, ["roomSize"]);
          (this.roomSize = new bo({
            context: this.context,
            value: t.roomSize,
            units: "normalRange",
          })),
            (this._scaleRoomSize = new lr({
              context: this.context,
              min: -0.733,
              max: 0.197,
            })),
            (this._allpassFilters = Ba.map((t) => {
              const e = this.context.createBiquadFilter();
              return (e.type = "allpass"), (e.frequency.value = t), e;
            })),
            (this._feedbackCombFilters = La.map((t, e) => {
              const s = new Hr({ context: this.context, delayTime: t });
              return (
        ...
        static getDefaults() {
          return Object.assign(Oa.getDefaults(), { roomSize: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class Ga extends Ua {
        constructor() {
          super(bi(Ga.getDefaults(), arguments, ["delayTime", "feedback"])),
            (this.name = "PingPongDelay");
          const t = bi(Ga.getDefaults(), arguments, ["delayTime", "feedback"]);
          (this._leftDelay = new Do({
            context: this.context,
            maxDelay: t.maxDelay,
          })),
            (this._rightDelay = new Do({
              context: this.context,
              maxDelay: t.maxDelay,
            })),
            (this._rightPreDelay = new Do({
              context: this.context,
              maxDelay: t.maxDelay,
            })),
            (this.delayTime = new bo({
              context: this.context,
              units: "time",
              value: t.delayTime,
            })),
      ...
      class Qa extends qa {
        constructor() {
          super(bi(Qa.getDefaults(), arguments, ["pitch"])),
            (this.name = "PitchShift");
          const t = bi(Qa.getDefaults(), arguments, ["pitch"]);
          (this._frequency = new bo({ context: this.context })),
            (this._delayA = new Do({ maxDelay: 1, context: this.context })),
            (this._lfoA = new dr({
              context: this.context,
              min: 0,
              max: 0.1,
            ...
            (this._delayB = new Do({ maxDelay: 1, context: this.context })),
            (this._lfoB = new dr({
              context: this.context,
              min: 0,
              max: 0.1,
            ...
            (this._crossFade = new ma({ context: this.context })),
      ...
      class Za extends Oa {
        constructor() {
          super(
            ...
            (this.name = "Phaser");
          const t = bi(Za.getDefaults(), arguments, [
            "frequency",
            "octaves",
            "baseFrequency",
          ]);
      ...
      class Xa extends ga {
        constructor() {
          super(bi(Xa.getDefaults(), arguments, ["decay"])),
            (this.name = "Reverb"),
            (this._convolver = this.context.createConvolver()),
            (this.ready = Promise.resolve());
          const t = bi(Xa.getDefaults(), arguments, ["decay"]);
          (this._decay = t.decay),
        ...
        set preDelay(t) {
          Yn((t = this.toSeconds(t)), 0), (this._preDelay = t), this.generate();
        }
        generate() {
          return di(this, void 0, void 0, function* () {
            const t = this.ready,
            ...
            const o = new yo({ context: e }).toDestination();
            i.connect(o),
              s.start(0),
              n.start(0),
      ...
      class Ya extends _o {
        constructor() {
          super(bi(Ya.getDefaults(), arguments)),
            (this.name = "MidSideSplit"),
            (this._split = this.input = new Aa({
              channels: 2,
              context: this.context,
            })),
            (this._midAdd = new ur({ context: this.context })),
            (this.mid = new sr({ context: this.context, value: Math.SQRT1_2 })),
            (this._sideSubtract = new br({ context: this.context })),
            (this.side = new sr({
              context: this.context,
              value: Math.SQRT1_2,
            })),
      ...
      class Ha extends _o {
        constructor() {
          super(bi(Ha.getDefaults(), arguments)),
            (this.name = "MidSideMerge"),
            (this.mid = new yo({ context: this.context })),
            (this.side = new yo({ context: this.context })),
            (this._left = new ur({ context: this.context })),
            (this._leftMult = new sr({
              context: this.context,
              value: Math.SQRT1_2,
            })),
            (this._right = new br({ context: this.context })),
            (this._rightMult = new sr({
              context: this.context,
              value: Math.SQRT1_2,
            })),
            (this._merge = this.output = new Da({ context: this.context })),
      ...
      class $a extends ga {
        constructor(t) {
          super(t),
            ...
            (this._midSideMerge = new Ha({ context: this.context })),
            (this._midSideSplit = new Ya({ context: this.context })),
      ...
      class Ja extends $a {
        constructor() {
          super(bi(Ja.getDefaults(), arguments, ["width"])),
            (this.name = "StereoWidener");
          const t = bi(Ja.getDefaults(), arguments, ["width"]);
          (this.width = new bo({
            context: this.context,
            value: t.width,
            units: "normalRange",
            ...
            ji(this, ["width"]),
            (this._twoTimesWidthMid = new sr({
              context: this.context,
              value: 2,
            })),
            (this._twoTimesWidthSide = new sr({
              context: this.context,
              value: 2,
            })),
            (this._midMult = new sr({ context: this.context })),
            this._twoTimesWidthMid.connect(this._midMult.factor),
            this.connectEffectMid(this._midMult),
            (this._oneMinusWidth = new br({ context: this.context })),
            this._oneMinusWidth.connect(this._twoTimesWidthMid),
            go(this.context.getConstant(1), this._oneMinusWidth),
            this.width.connect(this._oneMinusWidth.subtrahend),
            (this._sideMult = new sr({ context: this.context })),
            this.width.connect(this._twoTimesWidthSide),
            this._twoTimesWidthSide.connect(this._sideMult.factor),
            this.connectEffectSide(this._sideMult);
        }
        static getDefaults() {
          return Object.assign($a.getDefaults(), { width: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class Ka extends Oa {
        constructor() {
          super(bi(Ka.getDefaults(), arguments, ["frequency", "depth"])),
            (this.name = "Tremolo");
          const t = bi(Ka.getDefaults(), arguments, ["frequency", "depth"]);
          (this._lfoL = new dr({
            context: this.context,
            type: t.type,
            min: 1,
            ...
            (this._amplitudeL = new yo({ context: this.context })),
            (this._amplitudeR = new yo({ context: this.context })),
            (this.frequency = new bo({
              context: this.context,
              value: t.frequency,
              units: "frequency",
      ...
      class tc extends ga {
        constructor() {
          super(bi(tc.getDefaults(), arguments, ["frequency", "depth"])),
            (this.name = "Vibrato");
          const t = bi(tc.getDefaults(), arguments, ["frequency", "depth"]);
          (this._delayNode = new Do({
            context: this.context,
            delayTime: 0,
            maxDelay: t.maxDelay,
      ...
      class ec extends _o {
        constructor() {
          super(bi(ec.getDefaults(), arguments, ["type", "size"])),
            (this.name = "Analyser"),
            (this._analysers = []),
            (this._buffers = []);
          const t = bi(ec.getDefaults(), arguments, ["type", "size"]);
          (this.input = this.output = this._gain = new yo({
            context: this.context,
          })),
            (this._split = new Aa({
              context: this.context,
        ...
        set type(t) {
          Xn("waveform" === t || "fft" === t, "Analyser: invalid type: " + t),
            (this._type = t);
        }
        get smoothing() {
      ...
      class sc extends _o {
        constructor() {
          super(bi(sc.getDefaults(), arguments)),
            (this.name = "MeterBase"),
            (this.input = this.output = this._analyser = new ec({
              context: this.context,
              size: 256,
              type: "waveform",
            }));
      ...
      class nc extends sc {
        constructor() {
          super(bi(nc.getDefaults(), arguments, ["smoothing"])),
            (this.name = "Meter"),
            (this._rms = 0);
          const t = bi(nc.getDefaults(), arguments, ["smoothing"]);
          (this.input = this.output = this._analyser = new ec({
            context: this.context,
            size: 256,
            type: "waveform",
        ...
        static getDefaults() {
          return Object.assign(sc.getDefaults(), {
            smoothing: 0.8,
            normalRange: !1,
            channels: 1,
          });
        ...
        getLevel() {
          return (
            ti("'getLevel' has been changed to 'getValue'"), this.getValue()
          );
        }
        getValue() {
          const t = this._analyser.getValue(),
            e = (1 === this.channels ? [t] : t).map((t) => {
              ...
              return (
                ...
                this.normalRange ? this._rms : Hi(this._rms)
              );
            });
      ...
      class ic extends sc {
        constructor() {
          super(bi(ic.getDefaults(), arguments, ["size"])), (this.name = "FFT");
          const t = bi(ic.getDefaults(), arguments, ["size"]);
          (this.normalRange = t.normalRange),
      ...
      class oc extends sc {
        constructor() {
          super(bi(oc.getDefaults(), arguments)),
            (this.name = "DCMeter"),
      ...
      class rc extends sc {
        constructor() {
          super(bi(rc.getDefaults(), arguments, ["size"])),
            (this.name = "Waveform");
          const t = bi(rc.getDefaults(), arguments, ["size"]);
          (this._analyser.type = "waveform"), (this.size = t.size);
        }
        static getDefaults() {
          return Object.assign(sc.getDefaults(), { size: 1024 });
        }
        getValue() {
      ...
      class ac extends _o {
        constructor() {
          super(bi(ac.getDefaults(), arguments, ["solo"])),
            (this.name = "Solo");
          const t = bi(ac.getDefaults(), arguments, ["solo"]);
          (this.input = this.output = new yo({ context: this.context })),
            ac._allSolos.has(this.context) ||
              ac._allSolos.set(this.context, new Set()),
            ac._allSolos.get(this.context).add(this),
            (this.solo = t.solo);
        }
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { solo: !1 });
        }
        get solo() {
        ...
        set solo(t) {
          t ? this._addSolo() : this._removeSolo(),
            ac._allSolos.get(this.context).forEach((t) => t._updateSolo());
        }
        get muted() {
          return 0 === this.input.gain.value;
        }
        _addSolo() {
          ac._soloed.has(this.context) ||
            ac._soloed.set(this.context, new Set()),
            ac._soloed.get(this.context).add(this);
        }
        _removeSolo() {
          ac._soloed.has(this.context) &&
            ac._soloed.get(this.context).delete(this);
        }
        _isSoloed() {
          return (
            ac._soloed.has(this.context) &&
            ac._soloed.get(this.context).has(this)
          );
        }
        _noSolos() {
          return (
            !ac._soloed.has(this.context) ||
            (ac._soloed.has(this.context) &&
              0 === ac._soloed.get(this.context).size)
          );
        }
        _updateSolo() {
        ...
        dispose() {
          return (
            super.dispose(),
            ac._allSolos.get(this.context).delete(this),
            this._removeSolo(),
            this
          );
        }
      }
      (ac._allSolos = new Map()), (ac._soloed = new Map());
      class cc extends _o {
        constructor() {
          super(bi(cc.getDefaults(), arguments, ["pan", "volume"])),
            (this.name = "PanVol");
          const t = bi(cc.getDefaults(), arguments, ["pan", "volume"]);
          (this._panner = this.input = new xa({
            context: this.context,
            pan: t.pan,
            channelCount: t.channelCount,
          })),
      ...
      class hc extends _o {
        constructor() {
          super(bi(hc.getDefaults(), arguments, ["volume", "pan"])),
            (this.name = "Channel");
          const t = bi(hc.getDefaults(), arguments, ["volume", "pan"]);
          (this._solo = this.input = new ac({
            solo: t.solo,
            context: this.context,
          })),
            (this._panVol = this.output = new cc({
              context: this.context,
              pan: t.pan,
              volume: t.volume,
              mute: t.mute,
        ...
        _getBus(t) {
          return (
            hc.buses.has(t) ||
              hc.buses.set(t, new yo({ context: this.context })),
            hc.buses.get(t)
          );
        }
        send(t, e = 0) {
          const s = this._getBus(t),
            n = new yo({ context: this.context, units: "decibels", gain: e });
      ...
      class uc extends _o {
        constructor() {
          super(
            bi(uc.getDefaults(), arguments, ["lowFrequency", "highFrequency"])
          ),
          ...
          const t = bi(uc.getDefaults(), arguments, [
            "lowFrequency",
            "highFrequency",
          ]);
          (this.lowFrequency = new bo({
            context: this.context,
            units: "frequency",
            value: t.lowFrequency,
          })),
            (this.highFrequency = new bo({
              context: this.context,
              units: "frequency",
            ...
            ji(this, ["high", "mid", "low", "highFrequency", "lowFrequency"]);
        }
        static getDefaults() {
          return Object.assign(_o.getDefaults(), {
            Q: 1,
        ...
        dispose() {
          return (
            super.dispose(),
            Li(this, ["high", "mid", "low", "highFrequency", "lowFrequency"]),
            this.low.dispose(),
      ...
      class lc extends _o {
        constructor() {
          super(...arguments),
            (this.name = "Listener"),
            (this.positionX = new fo({
              context: this.context,
              param: this.context.rawContext.listener.positionX,
            })),
            (this.positionY = new fo({
              context: this.context,
              param: this.context.rawContext.listener.positionY,
            })),
            (this.positionZ = new fo({
              context: this.context,
              param: this.context.rawContext.listener.positionZ,
            })),
            (this.forwardX = new fo({
              context: this.context,
              param: this.context.rawContext.listener.forwardX,
            })),
            (this.forwardY = new fo({
              context: this.context,
              param: this.context.rawContext.listener.forwardY,
            })),
            (this.forwardZ = new fo({
              context: this.context,
      ...
      class pc extends _o {
        constructor() {
          super(
            ...
            (this.name = "Panner3D");
          const t = bi(pc.getDefaults(), arguments, [
            "positionX",
            "positionY",
            "positionZ",
          ]);
          (this._panner = this.input = this.output = this.context.createPanner()),
            ...
            (this.orientationX = new fo({
              context: this.context,
              param: this._panner.orientationX,
              value: t.orientationX,
            })),
            (this.orientationY = new fo({
              context: this.context,
              param: this._panner.orientationY,
              value: t.orientationY,
            })),
            (this.orientationZ = new fo({
              context: this.context,
      ...
      class dc extends _o {
        constructor() {
          super(bi(dc.getDefaults(), arguments)), (this.name = "Recorder");
          const t = bi(dc.getDefaults(), arguments);
          (this.input = new yo({ context: this.context })),
            Xn(dc.supported, "Media Recorder API is not available"),
        ...
        static getDefaults() {
          return _o.getDefaults();
        }
        get mimeType() {
          return this._recorder.mimeType;
        }
        static get supported() {
          return null !== ui && Reflect.has(ui, "MediaRecorder");
        }
        get state() {
        ...
        start() {
          return di(this, void 0, void 0, function* () {
            Xn("started" !== this.state, "Recorder is already started");
        ...
        stop() {
          return di(this, void 0, void 0, function* () {
            Xn("stopped" !== this.state, "Recorder is not started");
            const t = new Promise((t) => {
              const e = (s) => {
        ...
        pause() {
          return (
            Xn("started" === this.state, "Recorder must be started"),
      ...
      class fc extends _o {
        constructor() {
          super(bi(fc.getDefaults(), arguments, ["threshold", "ratio"])),
            (this.name = "Compressor"),
            (this._compressor = this.context.createDynamicsCompressor()),
            (this.input = this._compressor),
            (this.output = this._compressor);
          const t = bi(fc.getDefaults(), arguments, ["threshold", "ratio"]);
          (this.threshold = new fo({
            ...
            ji(this, ["knee", "release", "attack", "ratio", "threshold"]);
        }
        static getDefaults() {
          return Object.assign(_o.getDefaults(), {
            attack: 0.003,
      ...
      class _c extends _o {
        constructor() {
          super(
            Object.assign(
              bi(_c.getDefaults(), arguments, ["threshold", "smoothing"])
            )
          ),
            (this.name = "Gate");
          const t = bi(_c.getDefaults(), arguments, ["threshold", "smoothing"]);
          (this._follower = new ba({
            context: this.context,
            ...
            (this._gt = new Sr({
              context: this.context,
              value: Yi(t.threshold),
            })),
            (this.input = new yo({ context: this.context })),
            (this._gate = this.output = new yo({ context: this.context })),
      ...
      class mc extends _o {
        constructor() {
          super(Object.assign(bi(mc.getDefaults(), arguments, ["threshold"]))),
            (this.name = "Limiter");
          const t = bi(mc.getDefaults(), arguments, ["threshold"]);
          (this._compressor = this.input = this.output = new fc({
            context: this.context,
            ratio: 20,
            attack: 0,
            release: 0,
        ...
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { threshold: -12 });
        }
        get reduction() {
          return this._compressor.reduction;
        }
      ...
      class gc extends _o {
        constructor() {
          super(Object.assign(bi(gc.getDefaults(), arguments))),
            (this.name = "MidSideCompressor");
          const t = bi(gc.getDefaults(), arguments);
          (this._midSideSplit = this.input = new Ya({ context: this.context })),
            (this._midSideMerge = this.output = new Ha({
              context: this.context,
            })),
            (this.mid = new fc(
      ...
      class vc extends _o {
        constructor() {
          super(Object.assign(bi(vc.getDefaults(), arguments))),
            (this.name = "MultibandCompressor");
          const t = bi(vc.getDefaults(), arguments);
          (this._splitter = this.input = new uc({
            context: this.context,
      ...
      class yc extends _o {
        constructor() {
          super(bi(yc.getDefaults(), arguments, ["low", "mid", "high"])),
            (this.name = "EQ3"),
            (this.output = new yo({ context: this.context })),
            (this._internalChannels = []);
          const t = bi(yc.getDefaults(), arguments, ["low", "mid", "high"]);
          (this.input = this._multibandSplit = new uc({
            context: this.context,
            highFrequency: t.highFrequency,
            lowFrequency: t.lowFrequency,
          })),
            (this._lowGain = new yo({
              context: this.context,
              gain: t.low,
              units: "decibels",
            })),
            (this._midGain = new yo({
              context: this.context,
              gain: t.mid,
              units: "decibels",
            })),
            (this._highGain = new yo({
              context: this.context,
              gain: t.high,
              units: "decibels",
            })),
            ...
            ji(this, ["low", "mid", "high", "lowFrequency", "highFrequency"]),
        ...
        dispose() {
          return (
            super.dispose(),
            Li(this, ["low", "mid", "high", "lowFrequency", "highFrequency"]),
      ...
      class xc extends _o {
        constructor() {
          super(bi(xc.getDefaults(), arguments, ["url", "onload"])),
            (this.name = "Convolver"),
            (this._convolver = this.context.createConvolver());
          const t = bi(xc.getDefaults(), arguments, ["url", "onload"]);
          (this._buffer = new Bi(t.url, (e) => {
        ...
        static getDefaults() {
          return Object.assign(_o.getDefaults(), { normalize: !0, onload: zi });
        }
        load(t) {
          return di(this, void 0, void 0, function* () {
      ...
      const Tc = Qi().transport;
      function Sc() {
        return Qi().transport;
      }
      const kc = Qi().destination,
        Cc = Qi().destination;
      function Ac() {
        return Qi().destination;
      }
      const Dc = Qi().listener;
      function Oc() {
        return Qi().listener;
      }
      const Mc = Qi().draw;
